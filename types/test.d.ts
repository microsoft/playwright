...
export interface TestInfo {
   ...
   *
   * > Note that `pathSegments` accepts an array of path segments to the snapshot file such as
   * `testInfo.snapshotPath('relative', 'path', 'to', 'snapshot.png')`.
   ...
   * ```
   *
   * > Note that `pathSegments` accepts an array of path segments to the test output directory such as
