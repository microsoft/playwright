...
export const MetadataView: React.FunctionComponent<{
  ...
  return <div style={{ flex: 'auto', display: 'block', overflow: 'hidden auto' }}>
    ...
    {model.playwrightVersion && <div className='call-line'>version:<span className='call-value string' title={model.playwrightVersion}>{model.playwrightVersion}</span></div>}
