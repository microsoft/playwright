...
import type { APIRequestContext, BrowserContext, Browser, BrowserContextOptions, LaunchOptions, Page, Tracing } from 'playwright-core';
...
export function formatPendingCalls(calls: ParsedStackTrace[]) {
...
export function attachConnectedHeaderIfNeeded(testInfo: TestInfo, browser: Browser | null) {
...
export function markContextAsReused(context: BrowserContext) {
  (context as any)[kIsReusedContext] = true;
}

export function markContextAsStartedTearDown(context: BrowserContext) {
...
export function connectOptionsFromEnv() {
