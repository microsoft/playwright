...
export class Loader {
  ...
  private _processConfigObject(config: Config, configDir: string) {
    ...
    this._fullConfig.webServer = takeFirst(normalizeWebServerConfig(this._configOverrides.webServer), normalizeWebServerConfig(config.webServer), baseFullConfig.webServer);
