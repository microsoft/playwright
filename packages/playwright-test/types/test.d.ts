...
export interface TestError {
  /**
   * Error message. Set when [Error] (or its subclass) has been thrown. Also contains custom error properties, as
   * generated by [`util.inspect()`](https://nodejs.org/api/util.html#utilinspectobject-options).
   */
  message?: string;

  /**
   * Error stack. Set when [Error] (or its subclass) has been thrown. Note this only contains stack lines, but no
   * message, unlike the `error.stack` property.
   */
  stack?: string;
