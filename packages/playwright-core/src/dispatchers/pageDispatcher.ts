...
export class PageDispatcher
  extends Dispatcher<Page, channels.PageChannel>
  implements channels.PageChannel
{
  ...
  constructor(scope: DispatcherScope, page: Page) {
    ...
    page.on(Page.Events.Console, (message) =>
      this._dispatchEvent('console', {
        message: new ConsoleMessageDispatcher(this._scope, message),
      }),
    );
    ...
    page.on(Page.Events.Dialog, (dialog) =>
      this._dispatchEvent('dialog', { dialog: new DialogDispatcher(this._scope, dialog) }),
    );
    page.on(Page.Events.Download, (download: Download) => {
      this._dispatchEvent('download', {
        url: download.url,
        suggestedFilename: download.suggestedFilename(),
        artifact: new ArtifactDispatcher(scope, download.artifact),
      });
    });
    this._page.on(Page.Events.FileChooser, (fileChooser: FileChooser) =>
    ...
    page.on(Page.Events.PageError, (error) =>
      this._dispatchEvent('pageError', { error: serializeError(error) }),
    );
    page.on(Page.Events.WebSocket, (webSocket) =>
      this._dispatchEvent('webSocket', {
        webSocket: new WebSocketDispatcher(this._scope, webSocket),
      }),
    );
    page.on(Page.Events.Worker, (worker) =>
      this._dispatchEvent('worker', { worker: new WorkerDispatcher(this._scope, worker) }),
    );
    page.on(Page.Events.Video, (artifact: Artifact) =>
      this._dispatchEvent('video', { artifact: existingDispatcher<ArtifactDispatcher>(artifact) }),
    );
    if (page._video)
      this._dispatchEvent('video', {
        artifact: existingDispatcher<ArtifactDispatcher>(page._video),
      });
  ...
  async setDefaultNavigationTimeoutNoReply(
    params: channels.PageSetDefaultNavigationTimeoutNoReplyParams,
    metadata: CallMetadata,
  ): Promise<void> {
    this._page.setDefaultNavigationTimeout(params.timeout);
  }

  async setDefaultTimeoutNoReply(
    params: channels.PageSetDefaultTimeoutNoReplyParams,
    metadata: CallMetadata,
  ): Promise<void> {
  ...
  async exposeBinding(
    params: channels.PageExposeBindingParams,
    metadata: CallMetadata,
  ): Promise<void> {
  ...
  async setExtraHTTPHeaders(
    params: channels.PageSetExtraHTTPHeadersParams,
    metadata: CallMetadata,
  ): Promise<void> {
  ...
  async reload(
    params: channels.PageReloadParams,
    metadata: CallMetadata,
  ): Promise<channels.PageReloadResult> {
    return {
      response: lookupNullableDispatcher<ResponseDispatcher>(
  ...
  async goBack(
    params: channels.PageGoBackParams,
    metadata: CallMetadata,
  ): Promise<channels.PageGoBackResult> {
    return {
      response: lookupNullableDispatcher<ResponseDispatcher>(
  ...
  async goForward(
    params: channels.PageGoForwardParams,
    metadata: CallMetadata,
  ): Promise<channels.PageGoForwardResult> {
    return {
      response: lookupNullableDispatcher<ResponseDispatcher>(
  ...
  async emulateMedia(
    params: channels.PageEmulateMediaParams,
    metadata: CallMetadata,
  ): Promise<void> {
  ...
  async setViewportSize(
    params: channels.PageSetViewportSizeParams,
    metadata: CallMetadata,
  ): Promise<void> {
  ...
  async addInitScript(
    params: channels.PageAddInitScriptParams,
    metadata: CallMetadata,
  ): Promise<void> {
  ...
  async setNetworkInterceptionEnabled(
    params: channels.PageSetNetworkInterceptionEnabledParams,
    metadata: CallMetadata,
  ): Promise<void> {
    if (!params.enabled) {
    ...
    await this._page._setClientRequestInterceptor((route, request) => {
      this._dispatchEvent('route', {
        route: RouteDispatcher.from(this._scope, route),
  ...
  async screenshot(
    params: channels.PageScreenshotParams,
    metadata: CallMetadata,
  ): Promise<channels.PageScreenshotResult> {
    const mask: { frame: Frame; selector: string }[] = (params.mask || []).map(
      ({ frame, selector }) => ({
    ...
    return {
      binary: (await this._page.screenshot(metadata, { ...params, mask })).toString('base64'),
    };
  }
  ...
  async setFileChooserInterceptedNoReply(
    params: channels.PageSetFileChooserInterceptedNoReplyParams,
    metadata: CallMetadata,
  ): Promise<void> {
  ...
  async keyboardDown(
    params: channels.PageKeyboardDownParams,
    metadata: CallMetadata,
  ): Promise<void> {
  ...
  async keyboardInsertText(
    params: channels.PageKeyboardInsertTextParams,
    metadata: CallMetadata,
  ): Promise<void> {
  ...
  async keyboardType(
    params: channels.PageKeyboardTypeParams,
    metadata: CallMetadata,
  ): Promise<void> {
  ...
  async keyboardPress(
    params: channels.PageKeyboardPressParams,
    metadata: CallMetadata,
  ): Promise<void> {
  ...
  async touchscreenTap(
    params: channels.PageTouchscreenTapParams,
    metadata: CallMetadata,
  ): Promise<void> {
  ...
  async accessibilitySnapshot(
    params: channels.PageAccessibilitySnapshotParams,
    metadata: CallMetadata,
  ): Promise<channels.PageAccessibilitySnapshotResult> {
  ...
  async pdf(
    params: channels.PagePdfParams,
    metadata: CallMetadata,
  ): Promise<channels.PagePdfResult> {
  ...
  async bringToFront(
    params: channels.PageBringToFrontParams,
    metadata: CallMetadata,
  ): Promise<void> {
  ...
  async startJSCoverage(
    params: channels.PageStartJSCoverageParams,
    metadata: CallMetadata,
  ): Promise<void> {
  ...
  async stopJSCoverage(
    params: channels.PageStopJSCoverageParams,
    metadata: CallMetadata,
  ): Promise<channels.PageStopJSCoverageResult> {
    const coverage = this._page.coverage as CRCoverage;
    return { entries: await coverage.stopJSCoverage() };
  }

  async startCSSCoverage(
    params: channels.PageStartCSSCoverageParams,
    metadata: CallMetadata,
  ): Promise<void> {
    const coverage = this._page.coverage as CRCoverage;
  ...
  async stopCSSCoverage(
    params: channels.PageStopCSSCoverageParams,
    metadata: CallMetadata,
  ): Promise<channels.PageStopCSSCoverageResult> {
    const coverage = this._page.coverage as CRCoverage;
...
export class WorkerDispatcher
  extends Dispatcher<Worker, channels.WorkerChannel>
  implements channels.WorkerChannel
{
  _type_Worker = true;
  ...
  async evaluateExpression(
    params: channels.WorkerEvaluateExpressionParams,
    metadata: CallMetadata,
  ): Promise<channels.WorkerEvaluateExpressionResult> {
    return {
  ...
  async evaluateExpressionHandle(
    params: channels.WorkerEvaluateExpressionHandleParams,
    metadata: CallMetadata,
  ): Promise<channels.WorkerEvaluateExpressionHandleResult> {
    return {
      handle: ElementHandleDispatcher.fromJSHandle(
        this._scope,
...
export class BindingCallDispatcher
  extends Dispatcher<{ guid: string }, channels.BindingCallChannel>
  implements channels.BindingCallChannel
{
  ...
  constructor(
    ...
    super(scope, { guid: 'bindingCall@' + createGuid() }, 'BindingCall', {
      ...
      handle: needsHandle
        ? ElementHandleDispatcher.fromJSHandle(scope, args[0] as JSHandle)
        : undefined,
    });
