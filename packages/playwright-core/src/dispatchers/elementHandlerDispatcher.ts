...
export class ElementHandleDispatcher
  extends JSHandleDispatcher
  implements channels.ElementHandleChannel
{
  ...
  static from(scope: DispatcherScope, handle: ElementHandle): ElementHandleDispatcher {
    return (
      existingDispatcher<ElementHandleDispatcher>(handle) ||
  ...
  ): ElementHandleDispatcher | undefined {
  ...
  static fromJSHandle(scope: DispatcherScope, handle: js.JSHandle): JSHandleDispatcher {
    ...
    return handle.asElement()
      ...
      : new JSHandleDispatcher(scope, handle);
  }
  ...
  async ownerFrame(
    params: channels.ElementHandleOwnerFrameParams,
    metadata: CallMetadata,
  ): Promise<channels.ElementHandleOwnerFrameResult> {
    return {
      frame: lookupNullableDispatcher<FrameDispatcher>(await this._elementHandle.ownerFrame()),
    };
  }

  async contentFrame(
    params: channels.ElementHandleContentFrameParams,
    metadata: CallMetadata,
  ): Promise<channels.ElementHandleContentFrameResult> {
    return {
      frame: lookupNullableDispatcher<FrameDispatcher>(await this._elementHandle.contentFrame()),
    };
  }

  async getAttribute(
    params: channels.ElementHandleGetAttributeParams,
    metadata: CallMetadata,
  ): Promise<channels.ElementHandleGetAttributeResult> {
    const value = await this._elementHandle.getAttribute(params.name);
    return { value: value === null ? undefined : value };
  }

  async inputValue(
    params: channels.ElementHandleInputValueParams,
    metadata: CallMetadata,
  ): Promise<channels.ElementHandleInputValueResult> {
    const value = await this._elementHandle.inputValue();
    return { value };
  }

  async textContent(
    params: channels.ElementHandleTextContentParams,
    metadata: CallMetadata,
  ): Promise<channels.ElementHandleTextContentResult> {
    const value = await this._elementHandle.textContent();
    return { value: value === null ? undefined : value };
  }

  async innerText(
    params: channels.ElementHandleInnerTextParams,
    metadata: CallMetadata,
  ): Promise<channels.ElementHandleInnerTextResult> {
    return { value: await this._elementHandle.innerText() };
  }

  async innerHTML(
    params: channels.ElementHandleInnerHTMLParams,
    metadata: CallMetadata,
  ): Promise<channels.ElementHandleInnerHTMLResult> {
    return { value: await this._elementHandle.innerHTML() };
  }

  async isChecked(
    params: channels.ElementHandleIsCheckedParams,
    metadata: CallMetadata,
  ): Promise<channels.ElementHandleIsCheckedResult> {
    return { value: await this._elementHandle.isChecked() };
  }

  async isDisabled(
    params: channels.ElementHandleIsDisabledParams,
    metadata: CallMetadata,
  ): Promise<channels.ElementHandleIsDisabledResult> {
    return { value: await this._elementHandle.isDisabled() };
  }

  async isEditable(
    params: channels.ElementHandleIsEditableParams,
    metadata: CallMetadata,
  ): Promise<channels.ElementHandleIsEditableResult> {
    return { value: await this._elementHandle.isEditable() };
  }

  async isEnabled(
    params: channels.ElementHandleIsEnabledParams,
    metadata: CallMetadata,
  ): Promise<channels.ElementHandleIsEnabledResult> {
    return { value: await this._elementHandle.isEnabled() };
  }

  async isHidden(
    params: channels.ElementHandleIsHiddenParams,
    metadata: CallMetadata,
  ): Promise<channels.ElementHandleIsHiddenResult> {
    return { value: await this._elementHandle.isHidden() };
  }

  async isVisible(
    params: channels.ElementHandleIsVisibleParams,
    metadata: CallMetadata,
  ): Promise<channels.ElementHandleIsVisibleResult> {
    return { value: await this._elementHandle.isVisible() };
  }

  async dispatchEvent(
    params: channels.ElementHandleDispatchEventParams,
    metadata: CallMetadata,
  ): Promise<void> {
  ...
  async scrollIntoViewIfNeeded(
    params: channels.ElementHandleScrollIntoViewIfNeededParams,
    metadata: CallMetadata,
  ): Promise<void> {
  ...
  async dblclick(
    params: channels.ElementHandleDblclickParams,
    metadata: CallMetadata,
  ): Promise<void> {
  ...
  async selectOption(
    params: channels.ElementHandleSelectOptionParams,
    metadata: CallMetadata,
  ): Promise<channels.ElementHandleSelectOptionResult> {
    const elements = (params.elements || []).map(
      (e) => (e as ElementHandleDispatcher)._elementHandle,
    );
    return {
  ...
  async selectText(
    params: channels.ElementHandleSelectTextParams,
    metadata: CallMetadata,
  ): Promise<void> {
  ...
  async setInputFiles(
    params: channels.ElementHandleSetInputFilesParams,
    metadata: CallMetadata,
  ): Promise<void> {
  ...
  async uncheck(
    params: channels.ElementHandleUncheckParams,
    metadata: CallMetadata,
  ): Promise<void> {
  ...
  async boundingBox(
    params: channels.ElementHandleBoundingBoxParams,
    metadata: CallMetadata,
  ): Promise<channels.ElementHandleBoundingBoxResult> {
    const value = await this._elementHandle.boundingBox();
    return { value: value || undefined };
  }

  async screenshot(
    params: channels.ElementHandleScreenshotParams,
    metadata: CallMetadata,
  ): Promise<channels.ElementHandleScreenshotResult> {
    ...
    return {
      binary: (await this._elementHandle.screenshot(metadata, { ...params, mask })).toString(
        'base64',
      ),
    };
  }
  ...
  async querySelector(
    params: channels.ElementHandleQuerySelectorParams,
    metadata: CallMetadata,
  ): Promise<channels.ElementHandleQuerySelectorResult> {
  ...
  async querySelectorAll(
    params: channels.ElementHandleQuerySelectorAllParams,
    metadata: CallMetadata,
  ): Promise<channels.ElementHandleQuerySelectorAllResult> {
  ...
  async evalOnSelector(
    params: channels.ElementHandleEvalOnSelectorParams,
    metadata: CallMetadata,
  ): Promise<channels.ElementHandleEvalOnSelectorResult> {
    return {
  ...
  async evalOnSelectorAll(
    params: channels.ElementHandleEvalOnSelectorAllParams,
    metadata: CallMetadata,
  ): Promise<channels.ElementHandleEvalOnSelectorAllResult> {
    return {
      value: serializeResult(
  ...
  async waitForElementState(
    params: channels.ElementHandleWaitForElementStateParams,
    metadata: CallMetadata,
  ): Promise<void> {
  ...
  async waitForSelector(
    params: channels.ElementHandleWaitForSelectorParams,
    metadata: CallMetadata,
  ): Promise<channels.ElementHandleWaitForSelectorResult> {
    return {
