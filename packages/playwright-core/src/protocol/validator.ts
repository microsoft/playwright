...
import { scheme, tOptional, tObject, tBoolean, tInt, tFloat, tString, tAny, tEnum, tArray, tBinary, tChannel, tType, tSerializedValue } from './validatorPrimitives';
...
scheme.FrameExpectResult = tObject({
  ...
  received: tOptional(tObject({
    value: tOptional(tSerializedValue),
...
scheme.SerializedArgumentValue = tObject({
  n: tOptional(tFloat),
  ...
  a: tOptional(tArray(tType('SerializedArgumentValue'))),
  o: tOptional(tArray(tObject({
    k: tString,
    v: tType('SerializedArgumentValue'),
  }))),
  h: tOptional(tInt),
  id: tOptional(tInt),
  ref: tOptional(tInt),
...
scheme.SerializedArgument = tObject({
  value: tType('SerializedArgumentValue'),
