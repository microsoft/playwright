...
const kIcons: ElemDesc = {
  tagName: 'svg', children: [
    { tagName: 'defs', children: [
      { tagName: 'clipPath', attrs: { id: 'x-pw-gripper-icon', transform: 'scale(0.75, 0.75)', width: '16', height: '16', viewBox: '0 0 24 24', fill: 'currentColor' }, children: [
        { tagName: 'path', attrs: { d: 'M11 18c0 1.1-.9 2-2 2s-2-.9-2-2 .9-2 2-2 2 .9 2 2zm-2-8c-1.1 0-2 .9-2 2s.9 2 2 2 2-.9 2-2-.9-2-2-2zm0-6c-1.1 0-2 .9-2 2s.9 2 2 2 2-.9 2-2-.9-2-2-2zm6 4c1.1 0 2-.9 2-2s-.9-2-2-2-2 .9-2 2 .9 2 2 2zm0 2c-1.1 0-2 .9-2 2s.9 2 2 2 2-.9 2-2-.9-2-2-2zm0 6c-1.1 0-2 .9-2 2s.9 2 2 2 2-.9 2-2-.9-2-2-2z' } },
      ] },
    ] },
    { tagName: 'clipPath', attrs: { id: 'x-pw-record-icon', width: '16', height: '16', viewBox: '0 0 16 16', fill: 'currentColor' }, children: [
      { tagName: 'path', attrs: { d: 'M8 1a6.8 6.8 0 0 1 1.86.253 6.899 6.899 0 0 1 3.083 1.805 6.903 6.903 0 0 1 1.804 3.083C14.916 6.738 15 7.357 15 8s-.084 1.262-.253 1.86a6.9 6.9 0 0 1-.704 1.674 7.157 7.157 0 0 1-2.516 2.509 6.966 6.966 0 0 1-1.668.71A6.984 6.984 0 0 1 8 15a6.984 6.984 0 0 1-1.86-.246 7.098 7.098 0 0 1-1.674-.711 7.3 7.3 0 0 1-1.415-1.094 7.295 7.295 0 0 1-1.094-1.415 7.098 7.098 0 0 1-.71-1.675A6.985 6.985 0 0 1 1 8c0-.643.082-1.262.246-1.86a6.968 6.968 0 0 1 .711-1.667 7.156 7.156 0 0 1 2.509-2.516 6.895 6.895 0 0 1 1.675-.704A6.808 6.808 0 0 1 8 1z' } },
    ] },
    { tagName: 'clipPath', attrs: { id: 'x-pw-pick-locator-icon', width: '16', height: '16', viewBox: '0 0 16 16', fill: 'currentColor' }, children: [
      { tagName: 'path', attrs: { 'fill-rule': 'evenodd', 'clip-rule': 'evenodd', 'd': 'M1 3l1-1h12l1 1v6h-1V3H2v8h5v1H2l-1-1V3zm14.707 9.707L9 6v9.414l2.707-2.707h4zM10 13V8.414l3.293 3.293h-2L10 13z' } },
    ] },
    { tagName: 'clipPath', attrs: { id: 'x-pw-visibility-icon', width: '16', height: '16', viewBox: '0 0 16 16', fill: 'currentColor' }, children: [
      { tagName: 'path', attrs: { d: 'M7.99993 6.00316C9.47266 6.00316 10.6666 7.19708 10.6666 8.66981C10.6666 10.1426 9.47266 11.3365 7.99993 11.3365C6.52715 11.3365 5.33324 10.1426 5.33324 8.66981C5.33324 7.19708 6.52715 6.00316 7.99993 6.00316ZM7.99993 7.00315C7.07946 7.00315 6.33324 7.74935 6.33324 8.66981C6.33324 9.59028 7.07946 10.3365 7.99993 10.3365C8.9204 10.3365 9.6666 9.59028 9.6666 8.66981C9.6666 7.74935 8.9204 7.00315 7.99993 7.00315ZM7.99993 3.66675C11.0756 3.66675 13.7307 5.76675 14.4673 8.70968C14.5344 8.97755 14.3716 9.24908 14.1037 9.31615C13.8358 9.38315 13.5643 9.22041 13.4973 8.95248C12.8713 6.45205 10.6141 4.66675 7.99993 4.66675C5.38454 4.66675 3.12664 6.45359 2.50182 8.95555C2.43491 9.22341 2.16348 9.38635 1.89557 9.31948C1.62766 9.25255 1.46471 8.98115 1.53162 8.71321C2.26701 5.76856 4.9229 3.66675 7.99993 3.66675Z' } },
    ] },
    { tagName: 'clipPath', attrs: { id: 'x-pw-text-icon', width: '16', height: '16', viewBox: '0 0 16 16', fill: 'currentColor' }, children: [
      { tagName: 'path', attrs: { 'fill-rule': 'evenodd', 'clip-rule': 'evenodd', 'd': 'M0 11H1V13H15V11H16V14H15H1H0V11Z' } },
      { tagName: 'path', attrs: { d: 'M6.84048 11H5.95963V10.1406H5.93814C5.555 10.7995 4.99104 11.1289 4.24625 11.1289C3.69839 11.1289 3.26871 10.9839 2.95718 10.6938C2.64924 10.4038 2.49527 10.0189 2.49527 9.53906C2.49527 8.51139 3.10041 7.91341 4.3107 7.74512L5.95963 7.51416C5.95963 6.57959 5.58186 6.1123 4.82632 6.1123C4.16389 6.1123 3.56591 6.33789 3.03238 6.78906V5.88672C3.57307 5.54297 4.19612 5.37109 4.90152 5.37109C6.19416 5.37109 6.84048 6.05501 6.84048 7.42285V11ZM5.95963 8.21777L4.63297 8.40039C4.22476 8.45768 3.91682 8.55973 3.70914 8.70654C3.50145 8.84977 3.39761 9.10579 3.39761 9.47461C3.39761 9.74316 3.4925 9.96338 3.68228 10.1353C3.87564 10.3035 4.13166 10.3877 4.45035 10.3877C4.8872 10.3877 5.24706 10.2355 5.52994 9.93115C5.8164 9.62321 5.95963 9.2347 5.95963 8.76562V8.21777Z' } },
      { tagName: 'path', attrs: { d: 'M9.3475 10.2051H9.32601V11H8.44515V2.85742H9.32601V6.4668H9.3475C9.78076 5.73633 10.4146 5.37109 11.2489 5.37109C11.9543 5.37109 12.5057 5.61816 12.9032 6.1123C13.3042 6.60286 13.5047 7.26172 13.5047 8.08887C13.5047 9.00911 13.2809 9.74674 12.8333 10.3018C12.3857 10.8532 11.7734 11.1289 10.9964 11.1289C10.2695 11.1289 9.71989 10.821 9.3475 10.2051ZM9.32601 7.98682V8.75488C9.32601 9.20964 9.47282 9.59635 9.76644 9.91504C10.0636 10.2301 10.4396 10.3877 10.8944 10.3877C11.4279 10.3877 11.8451 10.1836 12.1458 9.77539C12.4502 9.36719 12.6024 8.79964 12.6024 8.07275C12.6024 7.46045 12.4609 6.98063 12.1781 6.6333C11.8952 6.28597 11.512 6.1123 11.0286 6.1123C10.5166 6.1123 10.1048 6.29134 9.7933 6.64941C9.48177 7.00391 9.32601 7.44971 9.32601 7.98682Z' } },
    ] },
    { tagName: 'clipPath', attrs: { id: 'x-pw-value-icon', width: '16', height: '16', viewBox: '0 0 16 16', fill: 'currentColor' }, children: [
      { tagName: 'path', attrs: { 'fill-rule': 'evenodd', 'clip-rule': 'evenodd', 'd': 'M4 6h8v1H4V6zm8 3H4v1h8V9z' } },
      { tagName: 'path', attrs: { 'fill-rule': 'evenodd', 'clip-rule': 'evenodd', 'd': 'M1 4l1-1h12l1 1v8l-1 1H2l-1-1V4zm1 0v8h12V4H2z' } },
    ] },
    { tagName: 'clipPath', attrs: { id: 'x-pw-accept-icon', transform: 'scale(0.75, 0.75)', width: '16', height: '16', viewBox: '0 0 24 24', fill: 'currentColor' }, children: [
      { tagName: 'path', attrs: { d: 'M9 16.17 4.83 12l-1.42 1.41L9 19 21 7l-1.41-1.41z' } },
    ] },
    { tagName: 'clipPath', attrs: { id: 'x-pw-cancel-icon', transform: 'scale(0.75, 0.75)', width: '16', height: '16', viewBox: '0 0 24 24', fill: 'currentColor' }, children: [
      { tagName: 'path', attrs: { d: 'M19 6.41 17.59 5 12 10.59 6.41 5 5 6.41 10.59 12 5 17.59 6.41 19 12 13.41 17.59 19 19 17.59 13.41 12z' } },
    ] },
    { tagName: 'clipPath', attrs: { id: 'x-pw-succeeded-icon', width: '16', height: '16', viewBox: '0 0 16 16', fill: 'currentColor' }, children: [
...
function createElement(doc: Document, { tagName, attrs, children }: ElemDesc): SVGElement {
  ...
  if (children) {
    for (const c of children)
      elem.appendChild(createElement(doc, c));
  }
...
class Overlay {
  ...
  constructor(recorder: Recorder) {
    ...
    this._overlayElement.appendChild(createElement(this._recorder.document, kIcons));
