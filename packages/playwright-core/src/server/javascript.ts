...
export class JSHandle<T = any> extends SdkObject {
  ...
  async evaluateExpression(progress: Progress, expression: string, options: { isFunction?: boolean, extendedSerialization?: boolean }, arg: any) {
    return await progress.race(this.internalEvaluateExpression(expression, options, arg));
  }

  async evaluateExpressionHandle(progress: Progress, expression: string, options: { isFunction?: boolean, extendedSerialization?: boolean }, arg: any): Promise<JSHandle<any>> {
  ...
  async internalEvaluateExpression(expression: string, options: { isFunction?: boolean, extendedSerialization?: boolean }, arg: any) {
    return await evaluateExpression(this._context, expression, { ...options, returnByValue: true }, this, arg);
  }

  private async _evaluateExpressionHandle(expression: string, options: { isFunction?: boolean, extendedSerialization?: boolean }, arg: any): Promise<JSHandle<any>> {
...
export async function evaluateExpression(context: ExecutionContext, expression: string, options: { returnByValue?: boolean, isFunction?: boolean, extendedSerialization?: boolean }, ...args: any[]): Promise<any> {
  ...
  const utilityScriptValues = [options.isFunction, options.returnByValue, options.extendedSerialization, expression, args.length, ...args];
