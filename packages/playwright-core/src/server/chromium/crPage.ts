...
class FrameSession {
  ...
  _onAttachedToTarget(event: Protocol.Target.attachedToTargetPayload) {
    ...
    session.on('Runtime.exceptionThrown', exception => this._page.emitOnContext(BrowserContext.Events.PageError, exceptionToError(exception.exceptionDetails), this._page));
  ...
  _handleException(exceptionDetails: Protocol.Runtime.ExceptionDetails) {
    this._page.emitOnContext(BrowserContext.Events.PageError, exceptionToError(exceptionDetails), this._page);
  }
