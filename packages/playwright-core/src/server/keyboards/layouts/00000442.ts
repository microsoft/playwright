...
// KLID 00000442 - Turkmen keyboard
const keyboardLayout: KeyboardLayout = {
  ...
  Backquote: { key: 'ž', keyCode: 192, shiftKey: 'Ž' },
  ...
  KeyQ: { key: 'ä', keyCode: 81, shiftKey: 'Ä' },
  ...
  BracketLeft: { key: 'ň', keyCode: 219, shiftKey: 'Ň' },
  BracketRight: { key: 'ö', keyCode: 221, shiftKey: 'Ö' },
  ...
  Backslash: { key: 'ş', keyCode: 220, shiftKey: 'Ş' },
  ...
  KeyX: { key: 'ü', keyCode: 88, shiftKey: 'Ü' },
  KeyC: { key: 'ç', keyCode: 67, shiftKey: 'Ç' },
  KeyV: { key: 'ý', keyCode: 86, shiftKey: 'Ý' },
