...
const keyboardLayout: KeyboardLayout = {
  ...
  Digit4: { key: '4', keyCode: 52, shiftKey: 'ç' },
  ...
  Equal: { key: 'Dead', keyCode: 221, shiftKey: 'Dead', deadKeyMappings: { 'a': 'â', 'e': 'ê', 'i': 'î', 'o': 'ô', 'u': 'û', 'A': 'Â', 'E': 'Ê', 'I': 'Î', 'O': 'Ô', 'U': 'Û', ' ': '^' }, shiftDeadKeyMappings: { 'a': 'à', 'e': 'è', 'i': 'ì', 'o': 'ò', 'u': 'ù', 'A': 'À', 'E': 'È', 'I': 'Ì', 'O': 'Ò', 'U': 'Ù', ' ': '`' } },
  ...
  BracketLeft: { key: 'è', keyCode: 186, shiftKey: 'ü' },
  BracketRight: { key: 'Dead', keyCode: 192, shiftKey: '!', deadKeyMappings: { 'a': 'ä', 'e': 'ë', 'i': 'ï', 'o': 'ö', 'u': 'ü', 'y': 'ÿ', 'A': 'Ä', 'E': 'Ë', 'I': 'Ï', 'O': 'Ö', 'U': 'Ü', ' ': '"' } },
  ...
  Quote: { key: 'à', keyCode: 220, shiftKey: 'ä' },
  Backslash: { key: '$', keyCode: 223, shiftKey: '£' },
