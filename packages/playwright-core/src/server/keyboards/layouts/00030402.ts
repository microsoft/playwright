...
// KLID 00030402 - Bulgarian keyboard
const keyboardLayout: KeyboardLayout = {
  ...
  Equal: { key: '.', keyCode: 190, shiftKey: '€' },
  Backspace: { key: 'Backspace', keyCode: 8 },
  Tab: { key: 'Tab', keyCode: 9 },
  KeyQ: { key: ',', keyCode: 188, shiftKey: 'ы' },
  KeyW: { key: 'у', keyCode: 87, shiftKey: 'У' },
  KeyE: { key: 'е', keyCode: 69, shiftKey: 'Е' },
  KeyR: { key: 'и', keyCode: 82, shiftKey: 'И' },
  KeyT: { key: 'ш', keyCode: 84, shiftKey: 'Ш' },
  KeyY: { key: 'щ', keyCode: 89, shiftKey: 'Щ' },
  KeyU: { key: 'к', keyCode: 85, shiftKey: 'К' },
  KeyI: { key: 'с', keyCode: 73, shiftKey: 'С' },
  KeyO: { key: 'д', keyCode: 79, shiftKey: 'Д' },
  KeyP: { key: 'з', keyCode: 80, shiftKey: 'З' },
  BracketLeft: { key: 'ц', keyCode: 219, shiftKey: 'Ц' },
  BracketRight: { key: ';', keyCode: 221, shiftKey: '§' },
  Enter: { key: 'Enter', keyCode: 13, text: '\r' },
  CapsLock: { key: 'CapsLock', keyCode: 20 },
  KeyA: { key: 'ь', keyCode: 65, shiftKey: 'ѝ' },
  KeyS: { key: 'я', keyCode: 83, shiftKey: 'Я' },
  KeyD: { key: 'а', keyCode: 68, shiftKey: 'А' },
  KeyF: { key: 'о', keyCode: 70, shiftKey: 'О' },
  KeyG: { key: 'ж', keyCode: 71, shiftKey: 'Ж' },
  KeyH: { key: 'г', keyCode: 72, shiftKey: 'Г' },
  KeyJ: { key: 'т', keyCode: 74, shiftKey: 'Т' },
  KeyK: { key: 'н', keyCode: 75, shiftKey: 'Н' },
  KeyL: { key: 'в', keyCode: 76, shiftKey: 'В' },
  Semicolon: { key: 'м', keyCode: 186, shiftKey: 'М' },
  Quote: { key: 'ч', keyCode: 222, shiftKey: 'Ч' },
  Backslash: { key: '„', keyCode: 220, shiftKey: '“' },
  ShiftLeft: { key: 'Shift', keyCode: 160, keyCodeWithoutLocation: 16, location: 1 },
  IntlBackslash: { key: 'ѝ', keyCode: 226, shiftKey: 'Ѝ' },
  KeyZ: { key: 'ю', keyCode: 90, shiftKey: 'Ю' },
  KeyX: { key: 'й', keyCode: 88, shiftKey: 'Й' },
  KeyC: { key: 'ъ', keyCode: 67, shiftKey: 'Ъ' },
  KeyV: { key: 'э', keyCode: 86, shiftKey: 'Э' },
  KeyB: { key: 'ф', keyCode: 66, shiftKey: 'Ф' },
  KeyN: { key: 'х', keyCode: 78, shiftKey: 'Х' },
  KeyM: { key: 'п', keyCode: 77, shiftKey: 'П' },
  Comma: { key: 'р', keyCode: 223, shiftKey: 'Р' },
  Period: { key: 'л', keyCode: 81, shiftKey: 'Л' },
  Slash: { key: 'б', keyCode: 191, shiftKey: 'Б' },
