...
// KLID 00000C1A - Serbian (Cyrillic) keyboard
const keyboardLayout: KeyboardLayout = {
  ...
  KeyY: { key: 'з', keyCode: 89, shiftKey: 'З' },
  ...
  BracketRight: { key: 'ђ', keyCode: 221, shiftKey: 'Ђ' },
  ...
  Quote: { key: 'ћ', keyCode: 222, shiftKey: 'Ћ' },
  ...
  KeyZ: { key: 'ѕ', keyCode: 90, shiftKey: 'Ѕ' },
  ...
  Slash: { key: '-', keyCode: 191, shiftKey: '_' },
