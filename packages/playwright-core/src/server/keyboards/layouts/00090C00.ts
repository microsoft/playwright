...
const keyboardLayout: KeyboardLayout = {
  ...
  Digit1: { key: '߁', keyCode: 49, shiftKey: '߹' },
  Digit2: { key: '߂', keyCode: 50, shiftKey: '@' },
  Digit3: { key: '߃', keyCode: 51, shiftKey: '#' },
  Digit4: { key: '߄', keyCode: 52, shiftKey: '$' },
  Digit5: { key: '߅', keyCode: 53, shiftKey: '%' },
  Digit6: { key: '߆', keyCode: 54, shiftKey: '߾' },
  Digit7: { key: '߇', keyCode: 55, shiftKey: '߿' },
  Digit8: { key: '߈', keyCode: 56, shiftKey: '*' },
  Digit9: { key: '߉', keyCode: 57, shiftKey: '(' },
  Digit0: { key: '߀', keyCode: 48, shiftKey: ')' },
  Minus: { key: '-', keyCode: 189, shiftKey: '_' },
  Equal: { key: '=', keyCode: 187, shiftKey: '+' },
  Backspace: { key: 'Backspace', keyCode: 8 },
  Tab: { key: 'Tab', keyCode: 9 },
  KeyQ: { key: 'ߔ', keyCode: 81, shiftKey: 'ߩ' },
  KeyW: { key: 'ߧ', keyCode: 87, shiftKey: 'ߨ' },
  KeyE: { key: 'ߠ', keyCode: 69 },
  KeyR: { key: 'ߥ', keyCode: 82 },
  KeyT: { key: 'ߦ', keyCode: 84 },
  KeyY: { key: 'ߙ', keyCode: 89, shiftKey: 'ߚ' },
  KeyU: { key: 'ߗ', keyCode: 85 },
  KeyI: { key: 'ߜ', keyCode: 73, shiftKey: '÷' },
  KeyO: { key: 'ߢ', keyCode: 79, shiftKey: '×' },
  KeyP: { key: 'ߡ', keyCode: 80, shiftKey: 'ߪ' },
  BracketLeft: { key: 'ߤ', keyCode: 219, shiftKey: '‹' },
  BracketRight: { key: 'ߒ', keyCode: 221, shiftKey: '›' },
  Enter: { key: 'Enter', keyCode: 13, text: '\r' },
  CapsLock: { key: 'CapsLock', keyCode: 20 },
  KeyA: { key: 'ߏ', keyCode: 65, shiftKey: '߶' },
  KeyS: { key: 'ߎ', keyCode: 83, shiftKey: '°' },
  KeyD: { key: 'ߍ', keyCode: 68, shiftKey: '[' },
  KeyF: { key: 'ߌ', keyCode: 70, shiftKey: ']' },
  KeyG: { key: 'ߋ', keyCode: 71, shiftKey: '﴾' },
  KeyH: { key: 'ߊ', keyCode: 72, shiftKey: '﴿' },
  KeyJ: { key: 'ߖ', keyCode: 74, shiftKey: 'ߺ' },
  KeyK: { key: 'ߝ', keyCode: 75, shiftKey: '،' },
  KeyL: { key: 'ߣ', keyCode: 76, shiftKey: '/' },
  Semicolon: { key: 'ߕ', keyCode: 186, shiftKey: ':' },
  Quote: { key: 'ߓ', keyCode: 222, shiftKey: '"' },
  ...
  KeyZ: { key: 'ߐ', keyCode: 90, shiftKey: '߳' },
  KeyX: { key: '߲', keyCode: 88, shiftKey: '߱' },
  KeyC: { key: 'ߵ', keyCode: 67, shiftKey: '߭' },
  KeyV: { key: 'ߴ', keyCode: 86, shiftKey: '߮' },
  KeyB: { key: '߬', keyCode: 66, shiftKey: '߰' },
  KeyN: { key: '߫', keyCode: 78, shiftKey: '߯' },
  KeyM: { key: 'ߟ', keyCode: 77, shiftKey: '߸' },
  Comma: { key: 'ߛ', keyCode: 188, shiftKey: 'ߑ' },
  Period: { key: 'ߘ', keyCode: 190, shiftKey: '.' },
  Slash: { key: 'ߞ', keyCode: 191, shiftKey: '؟' },
