...
// KLID 00020449 - Tamil 99 keyboard
const keyboardLayout: KeyboardLayout = {
  ...
  KeyQ: { key: 'ஆ', keyCode: 81, shiftKey: 'ஸ' },
  KeyW: { key: 'ஈ', keyCode: 87, shiftKey: 'ஷ' },
  KeyE: { key: 'ஊ', keyCode: 69, shiftKey: 'ஜ' },
  KeyR: { key: 'ஐ', keyCode: 82, shiftKey: 'ஹ' },
  KeyT: { key: 'ஏ', keyCode: 84, shiftKey: 'க்ஷ' },
  KeyY: { key: 'ள', keyCode: 89, shiftKey: 'ஶ்ரீ' },
  KeyU: { key: 'ற', keyCode: 85, shiftKey: 'ஶ' },
  KeyI: { key: 'ன', keyCode: 73 },
  KeyO: { key: 'ட', keyCode: 79, shiftKey: '[' },
  KeyP: { key: 'ண', keyCode: 80, shiftKey: ']' },
  BracketLeft: { key: 'ச', keyCode: 219, shiftKey: '{' },
  BracketRight: { key: 'ஞ', keyCode: 221, shiftKey: '}' },
  Enter: { key: 'Enter', keyCode: 13, text: '\r' },
  CapsLock: { key: 'CapsLock', keyCode: 20 },
  KeyA: { key: 'அ', keyCode: 65, shiftKey: '௹' },
  KeyS: { key: 'இ', keyCode: 83, shiftKey: '௺' },
  KeyD: { key: 'உ', keyCode: 68, shiftKey: '௸' },
  KeyF: { key: '்', keyCode: 70, shiftKey: 'ஃ' },
  KeyG: { key: 'எ', keyCode: 71, shiftKey: 'எ' },
  KeyH: { key: 'க', keyCode: 72, shiftKey: 'க' },
  KeyJ: { key: 'ப', keyCode: 74, shiftKey: 'ப' },
  KeyK: { key: 'ம', keyCode: 75, shiftKey: '"' },
  KeyL: { key: 'த', keyCode: 76, shiftKey: ':' },
  Semicolon: { key: 'ந', keyCode: 186, shiftKey: ';' },
  Quote: { key: 'ய', keyCode: 222, shiftKey: '\'' },
  ...
  KeyZ: { key: 'ஔ', keyCode: 90, shiftKey: '௳' },
  KeyX: { key: 'ஓ', keyCode: 88, shiftKey: '௴' },
  KeyC: { key: 'ஒ', keyCode: 67, shiftKey: '௵' },
  KeyV: { key: 'வ', keyCode: 86, shiftKey: '௶' },
  KeyB: { key: 'ங', keyCode: 66, shiftKey: '௷' },
  KeyN: { key: 'ல', keyCode: 78, shiftKey: 'ௐ' },
  KeyM: { key: 'ர', keyCode: 77, shiftKey: '/' },
  Comma: { key: ',', keyCode: 188, shiftKey: '<' },
  Period: { key: '.', keyCode: 190, shiftKey: '>' },
  Slash: { key: 'ழ', keyCode: 191, shiftKey: '?' },
