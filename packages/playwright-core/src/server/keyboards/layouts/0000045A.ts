...
const keyboardLayout: KeyboardLayout = {
  ...
  Backquote: { key: '܏', keyCode: 192, shiftKey: '̮' },
  Digit1: { key: '1', keyCode: 49, shiftKey: '!' },
  Digit2: { key: '2', keyCode: 50, shiftKey: '̊' },
  Digit3: { key: '3', keyCode: 51, shiftKey: '̥' },
  Digit4: { key: '4', keyCode: 52, shiftKey: '݉' },
  ...
  KeyQ: { key: 'ܔ', keyCode: 81, shiftKey: 'ܰ' },
  KeyW: { key: 'ܨ', keyCode: 87, shiftKey: 'ܳ' },
  KeyE: { key: 'ܖ', keyCode: 69, shiftKey: 'ܶ' },
  KeyR: { key: 'ܩ', keyCode: 82, shiftKey: 'ܺ' },
  KeyT: { key: 'ܦ', keyCode: 84, shiftKey: 'ܽ' },
  KeyY: { key: 'ܜ', keyCode: 89, shiftKey: '݀' },
  KeyU: { key: 'ܥ', keyCode: 85, shiftKey: '݁' },
  KeyI: { key: 'ܗ', keyCode: 73, shiftKey: '̈' },
  KeyO: { key: 'ܞ', keyCode: 79, shiftKey: '̄' },
  KeyP: { key: 'ܚ', keyCode: 80, shiftKey: '̇' },
  BracketLeft: { key: 'ܓ', keyCode: 219, shiftKey: '̃' },
  BracketRight: { key: 'ܕ', keyCode: 221, shiftKey: '݊' },
  Enter: { key: 'Enter', keyCode: 13, text: '\r' },
  CapsLock: { key: 'CapsLock', keyCode: 20 },
  KeyA: { key: 'ܫ', keyCode: 65, shiftKey: 'ܱ' },
  KeyS: { key: 'ܣ', keyCode: 83, shiftKey: 'ܴ' },
  KeyD: { key: 'ܝ', keyCode: 68, shiftKey: 'ܷ' },
  KeyF: { key: 'ܒ', keyCode: 70, shiftKey: 'ܻ' },
  KeyG: { key: 'ܠ', keyCode: 71, shiftKey: 'ܾ' },
  KeyH: { key: 'ܐ', keyCode: 72, shiftKey: 'ܑ' },
  KeyJ: { key: 'ܬ', keyCode: 74, shiftKey: 'ـ' },
  KeyK: { key: 'ܢ', keyCode: 75, shiftKey: '̤' },
  KeyL: { key: 'ܡ', keyCode: 76, shiftKey: '̱' },
  Semicolon: { key: 'ܟ', keyCode: 186, shiftKey: '̣' },
  Quote: { key: 'ܛ', keyCode: 222, shiftKey: '̰' },
  ...
  KeyZ: { key: ']', keyCode: 90, shiftKey: 'ܲ' },
  KeyX: { key: '[', keyCode: 88, shiftKey: 'ܵ' },
  KeyC: { key: 'ܤ', keyCode: 67, shiftKey: 'ܸ' },
  KeyV: { key: 'ܪ', keyCode: 86, shiftKey: 'ܼ' },
  KeyB: { key: 'ܧ', keyCode: 66, shiftKey: 'ܿ' },
  KeyN: { key: '܀', keyCode: 78, shiftKey: 'ܹ' },
  KeyM: { key: '.', keyCode: 77, shiftKey: '݂' },
  Comma: { key: 'ܘ', keyCode: 188, shiftKey: '،' },
  Period: { key: 'ܙ', keyCode: 190, shiftKey: '؛' },
