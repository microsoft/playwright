...
const keyboardLayout: KeyboardLayout = {
  ...
  KeyQ: { key: ';', keyCode: 81, shiftKey: ':' },
  KeyW: { key: 'ς', keyCode: 87, shiftKey: '΅' },
  KeyE: { key: 'ε', keyCode: 69, shiftKey: 'Ε' },
  KeyR: { key: 'ρ', keyCode: 82, shiftKey: 'Ρ' },
  KeyT: { key: 'τ', keyCode: 84, shiftKey: 'Τ' },
  KeyY: { key: 'υ', keyCode: 89, shiftKey: 'Υ' },
  KeyU: { key: 'θ', keyCode: 85, shiftKey: 'Θ' },
  KeyI: { key: 'ι', keyCode: 73, shiftKey: 'Ι' },
  KeyO: { key: 'ο', keyCode: 79, shiftKey: 'Ο' },
  KeyP: { key: 'π', keyCode: 80, shiftKey: 'Π' },
  ...
  KeyA: { key: 'α', keyCode: 65, shiftKey: 'Α' },
  KeyS: { key: 'σ', keyCode: 83, shiftKey: 'Σ' },
  KeyD: { key: 'δ', keyCode: 68, shiftKey: 'Δ' },
  KeyF: { key: 'φ', keyCode: 70, shiftKey: 'Φ' },
  KeyG: { key: 'γ', keyCode: 71, shiftKey: 'Γ' },
  KeyH: { key: 'η', keyCode: 72, shiftKey: 'Η' },
  KeyJ: { key: 'ξ', keyCode: 74, shiftKey: 'Ξ' },
  KeyK: { key: 'κ', keyCode: 75, shiftKey: 'Κ' },
  KeyL: { key: 'λ', keyCode: 76, shiftKey: 'Λ' },
  ...
  KeyZ: { key: 'ζ', keyCode: 90, shiftKey: 'Ζ' },
  KeyX: { key: 'χ', keyCode: 88, shiftKey: 'Χ' },
  KeyC: { key: 'ψ', keyCode: 67, shiftKey: 'Ψ' },
  KeyV: { key: 'ω', keyCode: 86, shiftKey: 'Ω' },
  KeyB: { key: 'β', keyCode: 66, shiftKey: 'Β' },
  KeyN: { key: 'ν', keyCode: 78, shiftKey: 'Ν' },
  KeyM: { key: 'μ', keyCode: 77, shiftKey: 'Μ' },
