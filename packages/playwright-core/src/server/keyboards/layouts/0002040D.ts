...
// KLID 0002040D - Hebrew (Standard) keyboard
const keyboardLayout: KeyboardLayout = {
  ...
  KeyQ: { key: '/', keyCode: 81, shiftKey: 'Q' },
  KeyW: { key: '\'', keyCode: 87, shiftKey: 'W' },
  KeyE: { key: 'ק', keyCode: 69, shiftKey: 'E' },
  KeyR: { key: 'ר', keyCode: 82, shiftKey: 'R' },
  KeyT: { key: 'א', keyCode: 84, shiftKey: 'T' },
  KeyY: { key: 'ט', keyCode: 89, shiftKey: 'Y' },
  KeyU: { key: 'ו', keyCode: 85, shiftKey: 'U' },
  KeyI: { key: 'ן', keyCode: 73, shiftKey: 'I' },
  KeyO: { key: 'ם', keyCode: 79, shiftKey: 'O' },
  KeyP: { key: 'פ', keyCode: 80, shiftKey: 'P' },
  ...
  KeyA: { key: 'ש', keyCode: 65, shiftKey: 'A' },
  KeyS: { key: 'ד', keyCode: 83, shiftKey: 'S' },
  KeyD: { key: 'ג', keyCode: 68, shiftKey: 'D' },
  KeyF: { key: 'כ', keyCode: 70, shiftKey: 'F' },
  KeyG: { key: 'ע', keyCode: 71, shiftKey: 'G' },
  KeyH: { key: 'י', keyCode: 72, shiftKey: 'H' },
  KeyJ: { key: 'ח', keyCode: 74, shiftKey: 'J' },
  KeyK: { key: 'ל', keyCode: 75, shiftKey: 'K' },
  KeyL: { key: 'ך', keyCode: 76, shiftKey: 'L' },
  Semicolon: { key: 'ף', keyCode: 186, shiftKey: ':' },
  ...
  KeyZ: { key: 'ז', keyCode: 90, shiftKey: 'Z' },
  KeyX: { key: 'ס', keyCode: 88, shiftKey: 'X' },
  KeyC: { key: 'ב', keyCode: 67, shiftKey: 'C' },
  KeyV: { key: 'ה', keyCode: 86, shiftKey: 'V' },
  KeyB: { key: 'נ', keyCode: 66, shiftKey: 'B' },
  KeyN: { key: 'מ', keyCode: 78, shiftKey: 'N' },
  KeyM: { key: 'צ', keyCode: 77, shiftKey: 'M' },
  Comma: { key: 'ת', keyCode: 188, shiftKey: '>' },
  Period: { key: 'ץ', keyCode: 190, shiftKey: '<' },
