...
// KLID 00010437 - Georgian (QWERTY) keyboard
const keyboardLayout: KeyboardLayout = {
  ...
  KeyQ: { key: 'ქ', keyCode: 81 },
  KeyW: { key: 'წ', keyCode: 87, shiftKey: 'ჭ' },
  KeyE: { key: 'ე', keyCode: 69 },
  KeyR: { key: 'რ', keyCode: 82, shiftKey: 'ღ' },
  KeyT: { key: 'ტ', keyCode: 84, shiftKey: 'თ' },
  KeyY: { key: 'ყ', keyCode: 89 },
  KeyU: { key: 'უ', keyCode: 85 },
  KeyI: { key: 'ი', keyCode: 73 },
  KeyO: { key: 'ო', keyCode: 79 },
  KeyP: { key: 'პ', keyCode: 80 },
  ...
  KeyA: { key: 'ა', keyCode: 65 },
  KeyS: { key: 'ს', keyCode: 83, shiftKey: 'შ' },
  KeyD: { key: 'დ', keyCode: 68 },
  KeyF: { key: 'ფ', keyCode: 70 },
  KeyG: { key: 'გ', keyCode: 71 },
  KeyH: { key: 'ჰ', keyCode: 72 },
  KeyJ: { key: 'ჯ', keyCode: 74, shiftKey: 'ჟ' },
  KeyK: { key: 'კ', keyCode: 75 },
  KeyL: { key: 'ლ', keyCode: 76, shiftKey: '₾' },
  ...
  IntlBackslash: { key: '\\', keyCode: 226 },
  KeyZ: { key: 'ზ', keyCode: 90, shiftKey: 'ძ' },
  KeyX: { key: 'ხ', keyCode: 88 },
  KeyC: { key: 'ც', keyCode: 67, shiftKey: 'ჩ' },
  KeyV: { key: 'ვ', keyCode: 86 },
  KeyB: { key: 'ბ', keyCode: 66 },
  KeyN: { key: 'ნ', keyCode: 78, shiftKey: 'N' },
  KeyM: { key: 'მ', keyCode: 77 },
