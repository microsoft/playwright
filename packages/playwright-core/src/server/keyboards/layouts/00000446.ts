...
// KLID 00000446 - Punjabi keyboard
const keyboardLayout: KeyboardLayout = {
  ...
  Backquote: { keyCode: 192, shiftKey: '੍ਹ' },
  Digit1: { key: '1', keyCode: 49, shiftKey: '੍ਵ' },
  Digit2: { key: '2', keyCode: 50, shiftKey: '੍ਯ' },
  Digit3: { key: '3', keyCode: 51, shiftKey: '੍ਰ' },
  ...
  KeyQ: { key: 'ੌ', keyCode: 81, shiftKey: 'ਔ' },
  KeyW: { key: 'ੈ', keyCode: 87, shiftKey: 'ਐ' },
  KeyE: { key: 'ਾ', keyCode: 69, shiftKey: 'ਆ' },
  KeyR: { key: 'ੀ', keyCode: 82, shiftKey: 'ਈ' },
  KeyT: { key: 'ੂ', keyCode: 84, shiftKey: 'ਊ' },
  KeyY: { key: 'ਬ', keyCode: 89, shiftKey: 'ਭ' },
  KeyU: { key: 'ਹ', keyCode: 85, shiftKey: 'ਙ' },
  KeyI: { key: 'ਗ', keyCode: 73, shiftKey: 'ਘ' },
  KeyO: { key: 'ਦ', keyCode: 79, shiftKey: 'ਧ' },
  KeyP: { key: 'ਜ', keyCode: 80, shiftKey: 'ਝ' },
  BracketLeft: { key: 'ਡ', keyCode: 219, shiftKey: 'ਢ' },
  BracketRight: { key: '਼', keyCode: 221, shiftKey: 'ਞ' },
  Enter: { key: 'Enter', keyCode: 13, text: '\r' },
  CapsLock: { key: 'CapsLock', keyCode: 20 },
  KeyA: { key: 'ੋ', keyCode: 65, shiftKey: 'ਓ' },
  KeyS: { key: 'ੇ', keyCode: 83, shiftKey: 'ਏ' },
  KeyD: { key: '੍', keyCode: 68, shiftKey: 'ਅ' },
  KeyF: { key: 'ਿ', keyCode: 70, shiftKey: 'ਇ' },
  KeyG: { key: 'ੁ', keyCode: 71, shiftKey: 'ਉ' },
  KeyH: { key: 'ਪ', keyCode: 72, shiftKey: 'ਫ' },
  KeyJ: { key: 'ਰ', keyCode: 74, shiftKey: 'ੜ' },
  KeyK: { key: 'ਕ', keyCode: 75, shiftKey: 'ਖ' },
  KeyL: { key: 'ਤ', keyCode: 76, shiftKey: 'ਥ' },
  Semicolon: { key: 'ਚ', keyCode: 186, shiftKey: 'ਛ' },
  Quote: { key: 'ਟ', keyCode: 222, shiftKey: 'ਠ' },
  Backslash: { keyCode: 220 },
  ShiftLeft: { key: 'Shift', keyCode: 160, keyCodeWithoutLocation: 16, location: 1 },
  IntlBackslash: { keyCode: 226 },
  KeyZ: { keyCode: 90 },
  KeyX: { key: 'ੰ', keyCode: 88, shiftKey: 'ਂ' },
  KeyC: { key: 'ਮ', keyCode: 67, shiftKey: 'ਣ' },
  KeyV: { key: 'ਨ', keyCode: 86 },
  KeyB: { key: 'ਵ', keyCode: 66, shiftKey: 'ੲ' },
  KeyN: { key: 'ਲ', keyCode: 78, shiftKey: 'ਲ਼' },
  KeyM: { key: 'ਸ', keyCode: 77, shiftKey: 'ਸ਼' },
  Comma: { key: ',', keyCode: 188 },
  Period: { key: '.', keyCode: 190, shiftKey: '।' },
  Slash: { key: 'ਯ', keyCode: 191 },
