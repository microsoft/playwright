...
// KLID 00000465 - Divehi Phonetic keyboard
const keyboardLayout: KeyboardLayout = {
  ...
  KeyQ: { key: 'ް', keyCode: 81, shiftKey: 'ޤ' },
  KeyW: { key: 'އ', keyCode: 87, shiftKey: 'ޢ' },
  KeyE: { key: 'ެ', keyCode: 69, shiftKey: 'ޭ' },
  KeyR: { key: 'ރ', keyCode: 82, shiftKey: 'ޜ' },
  KeyT: { key: 'ތ', keyCode: 84, shiftKey: 'ޓ' },
  KeyY: { key: 'ޔ', keyCode: 89, shiftKey: 'ޠ' },
  KeyU: { key: 'ު', keyCode: 85, shiftKey: 'ޫ' },
  KeyI: { key: 'ި', keyCode: 73, shiftKey: 'ީ' },
  KeyO: { key: 'ޮ', keyCode: 79, shiftKey: 'ޯ' },
  KeyP: { key: 'ޕ', keyCode: 80, shiftKey: '÷' },
  ...
  KeyA: { key: 'ަ', keyCode: 65, shiftKey: 'ާ' },
  KeyS: { key: 'ސ', keyCode: 83, shiftKey: 'ށ' },
  KeyD: { key: 'ދ', keyCode: 68, shiftKey: 'ޑ' },
  KeyF: { key: 'ފ', keyCode: 70, shiftKey: 'ﷲ' },
  KeyG: { key: 'ގ', keyCode: 71, shiftKey: 'ޣ' },
  KeyH: { key: 'ހ', keyCode: 72, shiftKey: 'ޙ' },
  KeyJ: { key: 'ޖ', keyCode: 74, shiftKey: 'ޛ' },
  KeyK: { key: 'ކ', keyCode: 75, shiftKey: 'ޚ' },
  KeyL: { key: 'ލ', keyCode: 76, shiftKey: 'ޅ' },
  ...
  KeyZ: { key: 'ޒ', keyCode: 90, shiftKey: 'ޡ' },
  KeyX: { key: '×', keyCode: 88, shiftKey: 'ޘ' },
  KeyC: { key: 'ޗ', keyCode: 67, shiftKey: 'ޝ' },
  KeyV: { key: 'ވ', keyCode: 86, shiftKey: 'ޥ' },
  KeyB: { key: 'ބ', keyCode: 66, shiftKey: 'ޞ' },
  KeyN: { key: 'ނ', keyCode: 78, shiftKey: 'ޏ' },
  KeyM: { key: 'މ', keyCode: 77, shiftKey: 'ޟ' },
