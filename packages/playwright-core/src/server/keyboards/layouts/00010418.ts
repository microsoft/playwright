...
// KLID 00010418 - Romanian (Standard) keyboard
const keyboardLayout: KeyboardLayout = {
  ...
  BracketLeft: { key: 'ă', keyCode: 219, shiftKey: 'Ă' },
  BracketRight: { key: 'î', keyCode: 221, shiftKey: 'Î' },
  ...
  Semicolon: { key: 'ș', keyCode: 186, shiftKey: 'Ș' },
  Quote: { key: 'ț', keyCode: 222, shiftKey: 'Ț' },
  Backslash: { key: 'â', keyCode: 220, shiftKey: 'Â' },
