...
const keyboardLayout: KeyboardLayout = {
  ...
  KeyQ: { key: 'چ', keyCode: 81 },
  KeyW: { key: 'ۋ', keyCode: 87 },
  KeyE: { key: 'ې', keyCode: 69 },
  KeyR: { key: 'ر', keyCode: 82 },
  KeyT: { key: 'ت', keyCode: 84 },
  KeyY: { key: 'ي', keyCode: 89 },
  KeyU: { key: 'ۇ', keyCode: 85 },
  KeyI: { key: 'ڭ', keyCode: 73 },
  KeyO: { key: 'و', keyCode: 79 },
  KeyP: { key: 'پ', keyCode: 80 },
  ...
  KeyA: { key: 'ھ', keyCode: 65 },
  KeyS: { key: 'س', keyCode: 83 },
  KeyD: { key: 'د', keyCode: 68, shiftKey: 'ژ' },
  KeyF: { key: 'ا', keyCode: 70, shiftKey: 'ف' },
  KeyG: { key: 'ە', keyCode: 71, shiftKey: 'گ' },
  KeyH: { key: 'ى', keyCode: 72, shiftKey: 'خ' },
  KeyJ: { key: 'ق', keyCode: 74, shiftKey: 'ج' },
  KeyK: { key: 'ك', keyCode: 75, shiftKey: 'ۆ' },
  KeyL: { key: 'ل', keyCode: 76, shiftKey: 'لا' },
  ...
  KeyZ: { key: 'ز', keyCode: 90 },
  KeyX: { key: 'ش', keyCode: 88 },
  KeyC: { key: 'غ', keyCode: 67 },
  KeyV: { key: 'ۈ', keyCode: 86 },
  KeyB: { key: 'ب', keyCode: 66 },
  KeyN: { key: 'ن', keyCode: 78 },
  KeyM: { key: 'م', keyCode: 77 },
  Comma: { key: '،', keyCode: 188, shiftKey: '>' },
  Period: { key: '.', keyCode: 190, shiftKey: '<' },
  Slash: { key: 'ئ', keyCode: 191, shiftKey: '؟' },
