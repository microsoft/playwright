...
// KLID 00000429 - Persian keyboard
const keyboardLayout: KeyboardLayout = {
  ...
  KeyR: { key: 'ق', keyCode: 82, shiftKey: 'ريال' },
  ...
  KeyA: { key: 'ش', keyCode: 65, shiftKey: 'َ' },
  KeyS: { key: 'س', keyCode: 83, shiftKey: 'ُ' },
  KeyD: { key: 'ی', keyCode: 68, shiftKey: 'ِ' },
  KeyF: { key: 'ب', keyCode: 70, shiftKey: 'ّ' },
  KeyG: { key: 'ل', keyCode: 71, shiftKey: 'ۀ' },
  ...
  Quote: { key: 'گ', keyCode: 222, shiftKey: '"' },
  Backslash: { key: 'پ', keyCode: 220, shiftKey: '|' },
  ShiftLeft: { key: 'Shift', keyCode: 160, keyCodeWithoutLocation: 16, location: 1 },
  IntlBackslash: { key: 'پ', keyCode: 226, shiftKey: '|' },
  KeyZ: { key: 'ظ', keyCode: 90, shiftKey: 'ة' },
  KeyX: { key: 'ط', keyCode: 88, shiftKey: 'ي' },
  KeyC: { key: 'ز', keyCode: 67, shiftKey: 'ژ' },
  KeyV: { key: 'ر', keyCode: 86, shiftKey: 'ؤ' },
  KeyB: { key: 'ذ', keyCode: 66, shiftKey: 'إ' },
  KeyN: { key: 'د', keyCode: 78, shiftKey: 'أ' },
  KeyM: { key: 'ئ', keyCode: 77, shiftKey: 'ء' },
