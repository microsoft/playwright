...
const keyboardLayout: KeyboardLayout = {
  ...
  Digit2: { key: 'ә', keyCode: 50, shiftKey: 'Ә' },
  Digit3: { key: 'і', keyCode: 51, shiftKey: 'І' },
  Digit4: { key: 'ң', keyCode: 52, shiftKey: 'Ң' },
  Digit5: { key: 'ғ', keyCode: 53, shiftKey: 'Ғ' },
  Digit6: { key: ',', keyCode: 54, shiftKey: ';' },
  Digit7: { key: '.', keyCode: 55, shiftKey: ':' },
  Digit8: { key: 'ү', keyCode: 56, shiftKey: 'Ү' },
  Digit9: { key: 'ұ', keyCode: 57, shiftKey: 'Ұ' },
  Digit0: { key: 'қ', keyCode: 48, shiftKey: 'Қ' },
  Minus: { key: 'ө', keyCode: 189, shiftKey: 'Ө' },
  Equal: { key: 'һ', keyCode: 187, shiftKey: 'Һ' },
