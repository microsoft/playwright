...
// KLID 00010427 - Lithuanian keyboard
const keyboardLayout: KeyboardLayout = {
  ...
  Digit1: { key: 'ą', keyCode: 49, shiftKey: 'Ą' },
  Digit2: { key: 'č', keyCode: 50, shiftKey: 'Č' },
  Digit3: { key: 'ę', keyCode: 51, shiftKey: 'Ę' },
  Digit4: { key: 'ė', keyCode: 52, shiftKey: 'Ė' },
  Digit5: { key: 'į', keyCode: 53, shiftKey: 'Į' },
  Digit6: { key: 'š', keyCode: 54, shiftKey: 'Š' },
  Digit7: { key: 'ų', keyCode: 55, shiftKey: 'Ų' },
  Digit8: { key: 'ū', keyCode: 56, shiftKey: 'Ū' },
  Digit9: { key: '9', keyCode: 57, shiftKey: '(' },
  Digit0: { key: '0', keyCode: 48, shiftKey: ')' },
  Minus: { key: '-', keyCode: 189, shiftKey: '_' },
  Equal: { key: 'ž', keyCode: 187, shiftKey: 'Ž' },
