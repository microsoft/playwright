...
// KLID 0000040F - Icelandic keyboard
const keyboardLayout: KeyboardLayout = {
  ...
  Minus: { key: 'ö', keyCode: 187, shiftKey: 'Ö' },
  Equal: { key: '-', keyCode: 219, shiftKey: '_' },
  ...
  BracketLeft: { key: 'ð', keyCode: 221, shiftKey: 'Ð' },
  ...
  Slash: { key: 'þ', keyCode: 189, shiftKey: 'Þ' },
