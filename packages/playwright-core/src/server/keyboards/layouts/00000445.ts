...
const keyboardLayout: KeyboardLayout = {
  ...
  Digit1: { key: '1', keyCode: 49, shiftKey: 'অ্যা' },
  Digit2: { key: '2', keyCode: 50 },
  Digit3: { key: '3', keyCode: 51, shiftKey: '্র' },
  Digit4: { key: '4', keyCode: 52, shiftKey: 'র্' },
  Digit5: { key: '5', keyCode: 53, shiftKey: 'জ্র' },
  Digit6: { key: '6', keyCode: 54, shiftKey: 'ত্ষ' },
  Digit7: { key: '7', keyCode: 55, shiftKey: 'ক্র' },
  Digit8: { key: '8', keyCode: 56, shiftKey: 'শ্র' },
