...
// KLID 0000105F - Tifinagh (Basic) keyboard
const keyboardLayout: KeyboardLayout = {
  ...
  Digit2: { key: 'Digit2', keyCode: 50, shiftKey: '2' },
  ...
  Digit7: { key: 'Digit7', keyCode: 55, shiftKey: '7' },
  Digit8: { key: '_', keyCode: 56, shiftKey: '8' },
  Digit9: { key: 'Digit9', keyCode: 57, shiftKey: '9' },
  Digit0: { key: 'Digit0', keyCode: 48, shiftKey: '0' },
  Minus: { key: ')', keyCode: 189, shiftKey: '°' },
  Equal: { key: '=', keyCode: 187, shiftKey: '+' },
  Backspace: { key: 'Backspace', keyCode: 8 },
  Tab: { key: 'Tab', keyCode: 9 },
  KeyQ: { key: 'ⴰ', keyCode: 81 },
  KeyW: { key: 'ⵣ', keyCode: 87, shiftKey: 'ⵥ' },
  KeyE: { key: 'ⴻ', keyCode: 69 },
  KeyR: { key: 'ⵔ', keyCode: 82, shiftKey: 'ⵕ' },
  KeyT: { key: 'ⵜ', keyCode: 84, shiftKey: 'ⵟ' },
  KeyY: { key: 'ⵢ', keyCode: 89 },
  KeyU: { key: 'ⵓ', keyCode: 85 },
  KeyI: { key: 'ⵉ', keyCode: 73 },
  KeyO: { key: 'ⵄ', keyCode: 79 },
  KeyP: { key: 'ⵃ', keyCode: 80 },
  BracketLeft: { key: 'ⵯ', keyCode: 219 },
  BracketRight: { key: '$', keyCode: 221, shiftKey: '£' },
  Enter: { key: 'Enter', keyCode: 13, text: '\r' },
  CapsLock: { key: 'CapsLock', keyCode: 20 },
  KeyA: { key: 'ⵇ', keyCode: 65 },
  KeyS: { key: 'ⵙ', keyCode: 83, shiftKey: 'ⵚ' },
  KeyD: { key: 'ⴷ', keyCode: 68, shiftKey: 'ⴹ' },
  KeyF: { key: 'ⴼ', keyCode: 70 },
  KeyG: { key: 'ⴳ', keyCode: 71 },
  KeyH: { key: 'ⵀ', keyCode: 72 },
  KeyJ: { key: 'ⵊ', keyCode: 74 },
  KeyK: { key: 'ⴽ', keyCode: 75 },
  KeyL: { key: 'ⵍ', keyCode: 76 },
  Semicolon: { key: 'ⵎ', keyCode: 186 },
  Quote: { key: 'Quote', keyCode: 222, shiftKey: '%' },
  ...
  KeyZ: { key: 'ⵡ', keyCode: 90 },
  KeyX: { key: 'ⵅ', keyCode: 88 },
  KeyC: { key: 'ⵛ', keyCode: 67 },
  KeyV: { key: 'ⵖ', keyCode: 86 },
  KeyB: { key: 'ⴱ', keyCode: 66 },
  KeyN: { key: 'ⵏ', keyCode: 78 },
  KeyM: { key: ',', keyCode: 77, shiftKey: '?' },
