...
// KLID 0000040E - Hungarian keyboard
const keyboardLayout: KeyboardLayout = {
  ...
  Backquote: { key: '0', keyCode: 48, shiftKey: '§' },
  ...
  Digit0: { key: 'ö', keyCode: 192, shiftKey: 'Ö' },
  Minus: { key: 'ü', keyCode: 191, shiftKey: 'Ü' },
  Equal: { key: 'ó', keyCode: 187, shiftKey: 'Ó' },
  ...
  BracketLeft: { key: 'ő', keyCode: 219, shiftKey: 'Ő' },
  BracketRight: { key: 'ú', keyCode: 221, shiftKey: 'Ú' },
  ...
  Semicolon: { key: 'é', keyCode: 186, shiftKey: 'É' },
  Quote: { key: 'á', keyCode: 222, shiftKey: 'Á' },
  Backslash: { key: 'ű', keyCode: 220, shiftKey: 'Ű' },
  ShiftLeft: { key: 'Shift', keyCode: 160, keyCodeWithoutLocation: 16, location: 1 },
  IntlBackslash: { key: 'í', keyCode: 226, shiftKey: 'Í' },
