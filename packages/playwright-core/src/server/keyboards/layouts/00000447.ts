...
// KLID 00000447 - Gujarati keyboard
const keyboardLayout: KeyboardLayout = {
  ...
  Equal: { key: 'ૃ', keyCode: 187, shiftKey: 'ઋ' },
  Backspace: { key: 'Backspace', keyCode: 8 },
  Tab: { key: 'Tab', keyCode: 9 },
  KeyQ: { key: 'ૌ', keyCode: 81, shiftKey: 'ઔ' },
  KeyW: { key: 'ૈ', keyCode: 87, shiftKey: 'ઐ' },
  KeyE: { key: 'ા', keyCode: 69, shiftKey: 'આ' },
  KeyR: { key: 'ી', keyCode: 82, shiftKey: 'ઈ' },
  KeyT: { key: 'ૂ', keyCode: 84, shiftKey: 'ઊ' },
  KeyY: { key: 'બ', keyCode: 89, shiftKey: 'ભ' },
  KeyU: { key: 'હ', keyCode: 85, shiftKey: 'ઙ' },
  KeyI: { key: 'ગ', keyCode: 73, shiftKey: 'ઘ' },
  KeyO: { key: 'દ', keyCode: 79, shiftKey: 'ધ' },
  KeyP: { key: 'જ', keyCode: 80, shiftKey: 'ઝ' },
  BracketLeft: { key: 'ડ', keyCode: 219, shiftKey: 'ઢ' },
  BracketRight: { key: '઼', keyCode: 221, shiftKey: 'ઞ' },
  Enter: { key: 'Enter', keyCode: 13, text: '\r' },
  CapsLock: { key: 'CapsLock', keyCode: 20 },
  KeyA: { key: 'ો', keyCode: 65, shiftKey: 'ઓ' },
  KeyS: { key: 'ે', keyCode: 83, shiftKey: 'એ' },
  KeyD: { key: '્', keyCode: 68, shiftKey: 'અ' },
  KeyF: { key: 'િ', keyCode: 70, shiftKey: 'ઇ' },
  KeyG: { key: 'ુ', keyCode: 71, shiftKey: 'ઉ' },
  KeyH: { key: 'પ', keyCode: 72, shiftKey: 'ફ' },
  KeyJ: { key: 'ર', keyCode: 74 },
  KeyK: { key: 'ક', keyCode: 75, shiftKey: 'ખ' },
  KeyL: { key: 'ત', keyCode: 76, shiftKey: 'થ' },
  Semicolon: { key: 'ચ', keyCode: 186, shiftKey: 'છ' },
  ...
  KeyB: { key: 'વ', keyCode: 66 },
  KeyN: { key: 'લ', keyCode: 78, shiftKey: 'ળ' },
  KeyM: { key: 'સ', keyCode: 77, shiftKey: 'શ' },
  Comma: { key: ',', keyCode: 188, shiftKey: 'ષ' },
  Period: { key: '.', keyCode: 190, shiftKey: '।' },
  Slash: { key: 'ય', keyCode: 191 },
