...
// KLID 0000044C - Malayalam keyboard
const keyboardLayout: KeyboardLayout = {
  ...
  Digit3: { key: '3', keyCode: 51, shiftKey: '്ര' },
  Digit4: { key: '4', keyCode: 52 },
  Digit5: { key: '5', keyCode: 53 },
  Digit6: { key: '6', keyCode: 54, shiftKey: 'ൿ' },
  Digit7: { key: '7', keyCode: 55, shiftKey: 'ക്ഷ' },
  Digit8: { key: '8', keyCode: 56, shiftKey: 'ൾ' },
  Digit9: { key: '9', keyCode: 57, shiftKey: '(' },
  Digit0: { key: '0', keyCode: 48, shiftKey: ')' },
  Minus: { key: '-', keyCode: 189, shiftKey: 'ഃ' },
  Equal: { key: 'ൃ', keyCode: 187, shiftKey: 'ഋ' },
  Backspace: { key: 'Backspace', keyCode: 8 },
  Tab: { key: 'Tab', keyCode: 9 },
  KeyQ: { key: 'ൌ', keyCode: 81, shiftKey: 'ഔ' },
  KeyW: { key: 'ൈ', keyCode: 87, shiftKey: 'ഐ' },
  KeyE: { key: 'ാ', keyCode: 69, shiftKey: 'ആ' },
  KeyR: { key: 'ീ', keyCode: 82, shiftKey: 'ഈ' },
  KeyT: { key: 'ൂ', keyCode: 84, shiftKey: 'ഊ' },
  KeyY: { key: 'ബ', keyCode: 89, shiftKey: 'ഭ' },
  KeyU: { key: 'ഹ', keyCode: 85, shiftKey: 'ങ' },
  KeyI: { key: 'ഗ', keyCode: 73, shiftKey: 'ഘ' },
  KeyO: { key: 'ദ', keyCode: 79, shiftKey: 'ധ' },
  KeyP: { key: 'ജ', keyCode: 80, shiftKey: 'ഝ' },
  BracketLeft: { key: 'ഡ', keyCode: 219, shiftKey: 'ഢ' },
  BracketRight: { key: 'ർ', keyCode: 221, shiftKey: 'ഞ' },
  Enter: { key: 'Enter', keyCode: 13, text: '\r' },
  CapsLock: { key: 'CapsLock', keyCode: 20 },
  KeyA: { key: 'ോ', keyCode: 65, shiftKey: 'ഓ' },
  KeyS: { key: 'േ', keyCode: 83, shiftKey: 'ഏ' },
  KeyD: { key: '്', keyCode: 68, shiftKey: 'അ' },
  KeyF: { key: 'ി', keyCode: 70, shiftKey: 'ഇ' },
  KeyG: { key: 'ു', keyCode: 71, shiftKey: 'ഉ' },
  KeyH: { key: 'പ', keyCode: 72, shiftKey: 'ഫ' },
  KeyJ: { key: 'ര', keyCode: 74, shiftKey: 'റ' },
  KeyK: { key: 'ക', keyCode: 75, shiftKey: 'ഖ' },
  KeyL: { key: 'ത', keyCode: 76, shiftKey: 'ഥ' },
  Semicolon: { key: 'ച', keyCode: 186, shiftKey: 'ഛ' },
  Quote: { key: 'ട', keyCode: 222, shiftKey: 'ഠ' },
  Backslash: { keyCode: 220 },
  ShiftLeft: { key: 'Shift', keyCode: 160, keyCodeWithoutLocation: 16, location: 1 },
  IntlBackslash: { keyCode: 226 },
  KeyZ: { key: 'െ', keyCode: 90, shiftKey: 'എ' },
  KeyX: { key: 'ം', keyCode: 88, shiftKey: 'ൺ' },
  KeyC: { key: 'മ', keyCode: 67, shiftKey: 'ണ' },
  KeyV: { key: 'ന', keyCode: 86, shiftKey: 'ൻ' },
  KeyB: { key: 'വ', keyCode: 66, shiftKey: 'ഴ' },
  KeyN: { key: 'ല', keyCode: 78, shiftKey: 'ള' },
  KeyM: { key: 'സ', keyCode: 77, shiftKey: 'ശ' },
  Comma: { key: ',', keyCode: 188, shiftKey: 'ഷ' },
  Period: { key: '.', keyCode: 190, shiftKey: 'ൽ' },
  Slash: { key: 'യ', keyCode: 191 },
