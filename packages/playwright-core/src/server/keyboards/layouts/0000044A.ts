...
const keyboardLayout: KeyboardLayout = {
  ...
  Digit3: { key: '3', keyCode: 51, shiftKey: '్ర' },
  Digit4: { key: '4', keyCode: 52 },
  Digit5: { key: '5', keyCode: 53, shiftKey: 'జ్ఞ' },
  Digit6: { key: '6', keyCode: 54, shiftKey: 'త్ర' },
  Digit7: { key: '7', keyCode: 55, shiftKey: 'క్ష' },
  Digit8: { key: '8', keyCode: 56, shiftKey: 'శ్ర' },
