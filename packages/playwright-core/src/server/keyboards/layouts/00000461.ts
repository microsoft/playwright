...
const keyboardLayout: KeyboardLayout = {
  ...
  Backquote: { key: 'ञ', keyCode: 192 },
  Digit1: { key: 'Digit1', keyCode: 49, shiftKey: '१' },
  ...
  KeyQ: { key: 'KeyQ', keyCode: 81, shiftKey: 'ो' },
  KeyW: { key: 'ध', keyCode: 87 },
  KeyE: { key: 'भ', keyCode: 69 },
  KeyR: { key: 'च', keyCode: 82 },
  KeyT: { key: 'त', keyCode: 84 },
  KeyY: { key: 'थ', keyCode: 89 },
  KeyU: { key: 'ग', keyCode: 85 },
  KeyI: { key: 'ष', keyCode: 73 },
  KeyO: { key: 'य', keyCode: 79, shiftKey: 'इ' },
  KeyP: { key: 'उ', keyCode: 80, shiftKey: 'ए' },
  BracketLeft: { key: 'ृ', keyCode: 219 },
  BracketRight: { key: 'े', keyCode: 221, shiftKey: 'ै' },
  Enter: { key: 'Enter', keyCode: 13, text: '\r' },
  CapsLock: { key: 'CapsLock', keyCode: 20 },
  KeyA: { key: 'ब', keyCode: 65 },
  KeyS: { key: 'क', keyCode: 83 },
  KeyD: { key: 'म', keyCode: 68 },
  KeyF: { key: 'ा', keyCode: 70, shiftKey: 'ँ' },
  KeyG: { key: 'न', keyCode: 71 },
  KeyH: { key: 'ज', keyCode: 72 },
  KeyJ: { key: 'व', keyCode: 74 },
  KeyK: { key: 'प', keyCode: 75 },
  KeyL: { key: 'ि', keyCode: 76, shiftKey: 'ी' },
  Semicolon: { key: 'स', keyCode: 186 },
  Quote: { key: 'ु', keyCode: 222, shiftKey: 'ू' },
  Backslash: { key: 'Backslash', keyCode: 220, shiftKey: '्' },
  ShiftLeft: { key: 'Shift', keyCode: 160, keyCodeWithoutLocation: 16, location: 1 },
  KeyZ: { key: 'श', keyCode: 90 },
  KeyX: { key: 'ह', keyCode: 88 },
  KeyC: { key: 'अ', keyCode: 67, shiftKey: 'ऋ' },
  KeyV: { key: 'ख', keyCode: 86 },
  KeyB: { key: 'द', keyCode: 66 },
  KeyN: { key: 'ल', keyCode: 78 },
  KeyM: { key: 'फ', keyCode: 77, shiftKey: 'ः' },
  Comma: { key: ',', keyCode: 188, shiftKey: '?' },
  Period: { key: '।', keyCode: 190 },
  Slash: { key: 'र', keyCode: 191 },
