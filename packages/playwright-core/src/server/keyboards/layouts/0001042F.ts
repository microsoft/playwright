...
// KLID 0001042F - Macedonian - Standard keyboard
const keyboardLayout: KeyboardLayout = {
  ...
  Backquote: { key: 'ѝ', keyCode: 192, shiftKey: 'Ѝ' },
  ...
  KeyQ: { key: 'љ', keyCode: 81, shiftKey: 'Љ' },
  KeyW: { key: 'њ', keyCode: 87, shiftKey: 'Њ' },
  KeyE: { key: 'е', keyCode: 69, shiftKey: 'Е' },
  KeyR: { key: 'р', keyCode: 82, shiftKey: 'Р' },
  KeyT: { key: 'т', keyCode: 84, shiftKey: 'Т' },
  KeyY: { key: 'ѕ', keyCode: 90, shiftKey: 'Ѕ' },
  KeyU: { key: 'у', keyCode: 85, shiftKey: 'У' },
  KeyI: { key: 'и', keyCode: 73, shiftKey: 'И' },
  KeyO: { key: 'о', keyCode: 79, shiftKey: 'О' },
  KeyP: { key: 'п', keyCode: 80, shiftKey: 'П' },
  BracketLeft: { key: 'ш', keyCode: 219, shiftKey: 'Ш' },
  BracketRight: { key: 'ѓ', keyCode: 221, shiftKey: 'Ѓ' },
  Enter: { key: 'Enter', keyCode: 13, text: '\r' },
  CapsLock: { key: 'CapsLock', keyCode: 20 },
  KeyA: { key: 'а', keyCode: 65, shiftKey: 'А' },
  KeyS: { key: 'с', keyCode: 83, shiftKey: 'С' },
  KeyD: { key: 'д', keyCode: 68, shiftKey: 'Д' },
  KeyF: { key: 'ф', keyCode: 70, shiftKey: 'Ф' },
  KeyG: { key: 'г', keyCode: 71, shiftKey: 'Г' },
  KeyH: { key: 'х', keyCode: 72, shiftKey: 'Х' },
  KeyJ: { key: 'ј', keyCode: 74, shiftKey: 'Ј' },
  KeyK: { key: 'к', keyCode: 75, shiftKey: 'К' },
  KeyL: { key: 'л', keyCode: 76, shiftKey: 'Л' },
  Semicolon: { key: 'ч', keyCode: 186, shiftKey: 'Ч' },
  Quote: { key: 'ќ', keyCode: 222, shiftKey: 'Ќ' },
  Backslash: { key: 'ж', keyCode: 220, shiftKey: 'Ж' },
  ShiftLeft: { key: 'Shift', keyCode: 160, keyCodeWithoutLocation: 16, location: 1 },
  IntlBackslash: { key: 'ѐ', keyCode: 226, shiftKey: 'Ѐ' },
  KeyZ: { key: 'з', keyCode: 89, shiftKey: 'З' },
  KeyX: { key: 'џ', keyCode: 88, shiftKey: 'Џ' },
  KeyC: { key: 'ц', keyCode: 67, shiftKey: 'Ц' },
  KeyV: { key: 'в', keyCode: 86, shiftKey: 'В' },
  KeyB: { key: 'б', keyCode: 66, shiftKey: 'Б' },
  KeyN: { key: 'н', keyCode: 78, shiftKey: 'Н' },
  KeyM: { key: 'м', keyCode: 77, shiftKey: 'М' },
  Comma: { key: ',', keyCode: 188, shiftKey: ';' },
  Period: { key: '.', keyCode: 190, shiftKey: ':' },
  Slash: { key: '/', keyCode: 189, shiftKey: '?' },
