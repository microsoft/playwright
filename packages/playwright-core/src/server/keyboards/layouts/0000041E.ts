...
// KLID 0000041E - Thai Kedmanee keyboard
const keyboardLayout: KeyboardLayout = {
  ...
  Backquote: { key: '_', keyCode: 192, shiftKey: '%' },
  Digit1: { key: 'ๅ', keyCode: 49, shiftKey: '+' },
  Digit2: { key: '/', keyCode: 50, shiftKey: '๑' },
  Digit3: { key: '-', keyCode: 51, shiftKey: '๒' },
  Digit4: { key: 'ภ', keyCode: 52, shiftKey: '๓' },
  Digit5: { key: 'ถ', keyCode: 53, shiftKey: '๔' },
  Digit6: { key: 'ุ', keyCode: 54, shiftKey: 'ู' },
  Digit7: { key: 'ึ', keyCode: 55, shiftKey: '฿' },
  Digit8: { key: 'ค', keyCode: 56, shiftKey: '๕' },
  Digit9: { key: 'ต', keyCode: 57, shiftKey: '๖' },
  Digit0: { key: 'จ', keyCode: 48, shiftKey: '๗' },
  Minus: { key: 'ข', keyCode: 189, shiftKey: '๘' },
  Equal: { key: 'ช', keyCode: 187, shiftKey: '๙' },
  Backspace: { key: 'Backspace', keyCode: 8 },
  Tab: { key: 'Tab', keyCode: 9 },
  KeyQ: { key: 'ๆ', keyCode: 81, shiftKey: '๐' },
  KeyW: { key: 'ไ', keyCode: 87, shiftKey: '"' },
  KeyE: { key: 'ำ', keyCode: 69, shiftKey: 'ฎ' },
  KeyR: { key: 'พ', keyCode: 82, shiftKey: 'ฑ' },
  KeyT: { key: 'ะ', keyCode: 84, shiftKey: 'ธ' },
  KeyY: { key: 'ั', keyCode: 89, shiftKey: 'ํ' },
  KeyU: { key: 'ี', keyCode: 85, shiftKey: '๊' },
  KeyI: { key: 'ร', keyCode: 73, shiftKey: 'ณ' },
  KeyO: { key: 'น', keyCode: 79, shiftKey: 'ฯ' },
  KeyP: { key: 'ย', keyCode: 80, shiftKey: 'ญ' },
  BracketLeft: { key: 'บ', keyCode: 219, shiftKey: 'ฐ' },
  BracketRight: { key: 'ล', keyCode: 221, shiftKey: ',' },
  Enter: { key: 'Enter', keyCode: 13, text: '\r' },
  CapsLock: { key: 'CapsLock', keyCode: 20 },
  KeyA: { key: 'ฟ', keyCode: 65, shiftKey: 'ฤ' },
  KeyS: { key: 'ห', keyCode: 83, shiftKey: 'ฆ' },
  KeyD: { key: 'ก', keyCode: 68, shiftKey: 'ฏ' },
  KeyF: { key: 'ด', keyCode: 70, shiftKey: 'โ' },
  KeyG: { key: 'เ', keyCode: 71, shiftKey: 'ฌ' },
  KeyH: { key: '้', keyCode: 72, shiftKey: '็' },
  KeyJ: { key: '่', keyCode: 74, shiftKey: '๋' },
  KeyK: { key: 'า', keyCode: 75, shiftKey: 'ษ' },
  KeyL: { key: 'ส', keyCode: 76, shiftKey: 'ศ' },
  Semicolon: { key: 'ว', keyCode: 186, shiftKey: 'ซ' },
  Quote: { key: 'ง', keyCode: 222, shiftKey: '.' },
  Backslash: { key: 'ฃ', keyCode: 220, shiftKey: 'ฅ' },
  ShiftLeft: { key: 'Shift', keyCode: 160, keyCodeWithoutLocation: 16, location: 1 },
  IntlBackslash: { key: 'ฃ', keyCode: 226, shiftKey: 'ฅ' },
  KeyZ: { key: 'ผ', keyCode: 90, shiftKey: '(' },
  KeyX: { key: 'ป', keyCode: 88, shiftKey: ')' },
  KeyC: { key: 'แ', keyCode: 67, shiftKey: 'ฉ' },
  KeyV: { key: 'อ', keyCode: 86, shiftKey: 'ฮ' },
  KeyB: { key: 'ิ', keyCode: 66, shiftKey: 'ฺ' },
  KeyN: { key: 'ื', keyCode: 78, shiftKey: '์' },
  KeyM: { key: 'ท', keyCode: 77, shiftKey: '?' },
  Comma: { key: 'ม', keyCode: 188, shiftKey: 'ฒ' },
  Period: { key: 'ใ', keyCode: 190, shiftKey: 'ฬ' },
  Slash: { key: 'ฝ', keyCode: 191, shiftKey: 'ฦ' },
