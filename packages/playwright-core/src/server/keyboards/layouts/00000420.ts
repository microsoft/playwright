...
const keyboardLayout: KeyboardLayout = {
  ...
  Digit7: { key: '7', keyCode: 55, shiftKey: 'ۖ' },
  ...
  KeyQ: { key: 'ط', keyCode: 81, shiftKey: 'ظ' },
  KeyW: { key: 'ص', keyCode: 87, shiftKey: 'ض' },
  KeyE: { key: 'ھ', keyCode: 69, shiftKey: 'ذ' },
  KeyR: { key: 'د', keyCode: 82, shiftKey: 'ڈ' },
  KeyT: { key: 'ٹ', keyCode: 84, shiftKey: 'ث' },
  KeyY: { key: 'پ', keyCode: 89, shiftKey: 'ّ' },
  KeyU: { key: 'ت', keyCode: 85, shiftKey: 'ۃ' },
  KeyI: { key: 'ب', keyCode: 73, shiftKey: 'ـ' },
  KeyO: { key: 'ج', keyCode: 79, shiftKey: 'چ' },
  KeyP: { key: 'ح', keyCode: 80, shiftKey: 'خ' },
  ...
  KeyA: { key: 'م', keyCode: 65, shiftKey: 'ژ' },
  KeyS: { key: 'و', keyCode: 83, shiftKey: 'ز' },
  KeyD: { key: 'ر', keyCode: 68, shiftKey: 'ڑ' },
  KeyF: { key: 'ن', keyCode: 70, shiftKey: 'ں' },
  KeyG: { key: 'ل', keyCode: 71, shiftKey: 'ۂ' },
  KeyH: { key: 'ہ', keyCode: 72, shiftKey: 'ء' },
  KeyJ: { key: 'ا', keyCode: 74, shiftKey: 'آ' },
  KeyK: { key: 'ک', keyCode: 75, shiftKey: 'گ' },
  KeyL: { key: 'ی', keyCode: 76, shiftKey: 'ي' },
  ...
  KeyZ: { key: 'ق', keyCode: 90, shiftKey: '‍' },
  KeyX: { key: 'ف', keyCode: 88, shiftKey: '‌' },
  KeyC: { key: 'ے', keyCode: 67, shiftKey: 'ۓ' },
  KeyV: { key: 'س', keyCode: 86, shiftKey: '‎' },
  KeyB: { key: 'ش', keyCode: 66, shiftKey: 'ؤ' },
  KeyN: { key: 'غ', keyCode: 78, shiftKey: 'ئ' },
  KeyM: { key: 'ع', keyCode: 77, shiftKey: '‏' },
