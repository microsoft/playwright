...
// KLID 00000492 - Central Kurdish keyboard
const keyboardLayout: KeyboardLayout = {
  ...
  Digit1: { key: '١', keyCode: 49, shiftKey: '!' },
  Digit2: { key: '٢', keyCode: 50, shiftKey: '@' },
  Digit3: { key: '٣', keyCode: 51, shiftKey: '#' },
  Digit4: { key: '٤', keyCode: 52, shiftKey: '$' },
  Digit5: { key: '٥', keyCode: 53, shiftKey: '٪' },
  Digit6: { key: '٦', keyCode: 54, shiftKey: '^' },
  Digit7: { key: '٧', keyCode: 55, shiftKey: '&' },
  Digit8: { key: '٨', keyCode: 56, shiftKey: '*' },
  Digit9: { key: '٩', keyCode: 57, shiftKey: ')' },
  Digit0: { key: '٠', keyCode: 48, shiftKey: '(' },
  Minus: { key: '-', keyCode: 189, shiftKey: '_' },
  Equal: { key: '=', keyCode: 187, shiftKey: '+' },
  Backspace: { key: 'Backspace', keyCode: 8 },
  Tab: { key: 'Tab', keyCode: 9 },
  KeyQ: { key: 'ق', keyCode: 81, shiftKey: '`' },
  KeyW: { key: 'و', keyCode: 87, shiftKey: 'وو' },
  KeyE: { key: 'ە', keyCode: 69, shiftKey: 'ي' },
  KeyR: { key: 'ر', keyCode: 82, shiftKey: 'ڕ' },
  KeyT: { key: 'ت', keyCode: 84, shiftKey: 'ط' },
  KeyY: { key: 'ی', keyCode: 89, shiftKey: 'ێ' },
  KeyU: { key: 'ئ', keyCode: 85, shiftKey: 'ء' },
  KeyI: { key: 'ح', keyCode: 73, shiftKey: 'ع' },
  KeyO: { key: 'ۆ', keyCode: 79, shiftKey: 'ؤ' },
  KeyP: { key: 'پ', keyCode: 80, shiftKey: 'ث' },
  ...
  KeyA: { key: 'ا', keyCode: 65, shiftKey: 'آ' },
  KeyS: { key: 'س', keyCode: 83, shiftKey: 'ش' },
  KeyD: { key: 'د', keyCode: 68, shiftKey: 'ذ' },
  KeyF: { key: 'ف', keyCode: 70, shiftKey: 'إ' },
  KeyG: { key: 'گ', keyCode: 71, shiftKey: 'غ' },
  KeyH: { key: 'ه', keyCode: 72, shiftKey: '‌' },
  KeyJ: { key: 'ژ', keyCode: 74, shiftKey: 'أ' },
  KeyK: { key: 'ک', keyCode: 75, shiftKey: 'ك' },
  KeyL: { key: 'ل', keyCode: 76, shiftKey: 'ڵ' },
  ...
  KeyZ: { key: 'ز', keyCode: 90, shiftKey: 'ض' },
  KeyX: { key: 'خ', keyCode: 88, shiftKey: 'ص' },
  KeyC: { key: 'ج', keyCode: 67, shiftKey: 'چ' },
  KeyV: { key: 'ڤ', keyCode: 86, shiftKey: 'ظ' },
  KeyB: { key: 'ب', keyCode: 66, shiftKey: 'ى' },
  KeyN: { key: 'ن', keyCode: 78, shiftKey: 'ة' },
  KeyM: { key: 'م', keyCode: 77, shiftKey: 'ـ' },
