...
const DOWNLOAD_PATHS = {
  'chromium': {
    '<unknown>': undefined,
    'generic-linux-x64': 'builds/chromium/%s/chromium-linux.zip',
  ...
  'chromium-tip-of-tree': {
    '<unknown>': undefined,
    'generic-linux-x64': 'builds/chromium-tip-of-tree/%s/chromium-tip-of-tree-linux.zip',
  ...
  'chromium-with-symbols': {
    '<unknown>': undefined,
    'generic-linux-x64': 'builds/chromium/%s/chromium-with-symbols-linux.zip',
  ...
  'firefox': {
    '<unknown>': undefined,
    'generic-linux-x64': 'builds/firefox/%s/firefox-ubuntu-20.04.zip',
  ...
  'firefox-beta': {
    '<unknown>': undefined,
    'generic-linux-x64': 'builds/firefox-beta/%s/firefox-beta-ubuntu-20.04.zip',
  ...
  'firefox-asan': {
    '<unknown>': undefined,
    'generic-linux-x64': 'builds/firefox/%s/firefox-asan-ubuntu-20.04.zip',
    'generic-linux-arm64': undefined,
  ...
  'webkit': {
    '<unknown>': undefined,
    'generic-linux-x64': 'builds/webkit/%s/webkit-ubuntu-20.04.zip',
  ...
  'ffmpeg': {
    '<unknown>': undefined,
    'generic-linux-x64': 'builds/ffmpeg/%s/ffmpeg-linux.zip',
...
export class Registry {
  ...
  private async _downloadExecutable(descriptor: BrowsersJSONDescriptor, executablePath?: string) {
    ...
    if (hostPlatform === 'generic-linux-x64' || hostPlatform === 'generic-linux-arm64')
