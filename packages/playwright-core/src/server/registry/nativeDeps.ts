...
export const deps: any = {
  ...
  'almalinux10-x64': {
    ...
    lib2package: {
      ...
      'libgtk-4.so.1': 'gtk4',
      'libicudata.so.76': 'libicu',
      'libicui18n.so.76': 'libicu',
      'libicuuc.so.76': 'libicu',
...
deps['almalinux10-arm64'] = {
  tools: [...deps['almalinux10-x64'].tools],
  chromium: [...deps['almalinux10-x64'].chromium],
  firefox: [
    ...deps['almalinux10-x64'].firefox,
  ],
  webkit: [
    ...deps['almalinux10-x64'].webkit,
  ],
  lib2package: {
    ...deps['almalinux10-x64'].lib2package,
  },
};
