...
export const deps: any = {
  ...
  'fedora-x64': {
    ...
    lib2package: {
      ...
      'libwayland-client.so.0': 'libwayland-client',
      'libwayland-egl.so.1': 'libwayland-egl',
      'libwayland-server.so.0': 'libwayland-server',
...
deps['fedora-arm64'] = {
  ...
  firefox: [
    ...deps['fedora-x64'].firefox,
  ],
  webkit: [
    ...deps['fedora-x64'].webkit,
  ],
  lib2package: {
