...
export class Frame extends ChannelOwner<channels.FrameChannel> implements api.Frame {
  ...
  async goto(
    url: string,
    options: channels.FrameGotoOptions = {},
  ...
  async dragAndDrop(
    source: string,
    target: string,
    options: channels.FrameDragAndDropOptions = {},
  ) {
  ...
  async textContent(
    selector: string,
    options: channels.FrameTextContentOptions = {},
  ): Promise<null | string> {
  ...
  async getAttribute(
    selector: string,
    name: string,
    options: channels.FrameGetAttributeOptions = {},
  ): Promise<string | null> {
  ...
  async inputValue(
    selector: string,
    options: channels.FrameInputValueOptions = {},
  ): Promise<string> {
  ...
  async isChecked(
    selector: string,
    options: channels.FrameIsCheckedOptions = {},
  ): Promise<boolean> {
  ...
  async isDisabled(
    selector: string,
    options: channels.FrameIsDisabledOptions = {},
  ): Promise<boolean> {
  ...
  async isEditable(
    selector: string,
    options: channels.FrameIsEditableOptions = {},
  ): Promise<boolean> {
  ...
  async isEnabled(
    selector: string,
    options: channels.FrameIsEnabledOptions = {},
  ): Promise<boolean> {
  ...
  async isVisible(
    selector: string,
    options: channels.FrameIsVisibleOptions = {},
  ): Promise<boolean> {
  ...
  async setInputFiles(
    ...
    options: channels.FrameSetInputFilesOptions = {},
  ): Promise<void> {
