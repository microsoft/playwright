            ...
            return async (params: any) => {
              return await this._wrapApiCall(async apiZone => {
                ...
                if (!apiZone.internal && !apiZone.reported) {
                  ...
                  return await this._connection.sendMessageToServer(this, prop, validatedParams, apiZone.title ?? apiZone.apiName, apiZone.internal, apiZone.frames, apiZone.stepId);
                }
                // Since this api call is either internal, or has already been reported/traced once,
                // passing as internal.
                return await this._connection.sendMessageToServer(this, prop, validatedParams, undefined, true, [], undefined);
              }, { internal });
            };
          }
        }
