          ...
          if (validator) {
            return (params: any) => {
              return this._wrapApiCall(apiZone => {
                ...
                return this._connection.sendMessageToServer(this, prop, validator(params, '', { tChannelImpl: tChannelImplToWire, binary: this._connection.bufferBinaryFormat() === 'base64' ? 'toBase64' : 'buffer' }), apiName, frames, wallTime);
              });
            };
          }
        }
