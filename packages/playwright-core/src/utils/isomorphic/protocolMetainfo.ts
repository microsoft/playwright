...
export const methodMetainfo = new Map<string, MethodMetainfo>([
  ...
  ['Page.keyboardDown', { title: 'Key down "{key}"', slowMo: true, snapshot: true, pause: true, }],
  ['Page.keyboardUp', { title: 'Key up "{key}"', slowMo: true, snapshot: true, pause: true, }],
  ['Page.keyboardInsertText', { title: 'Insert "{text}"', slowMo: true, snapshot: true, pause: true, }],
  ['Page.keyboardType', { title: 'Type "{text}"', slowMo: true, snapshot: true, pause: true, }],
  ['Page.keyboardPress', { title: 'Press "{key}"', slowMo: true, snapshot: true, pause: true, }],
  ['Page.mouseMove', { title: 'Mouse move', slowMo: true, snapshot: true, pause: true, }],
  ['Page.mouseDown', { title: 'Mouse down', slowMo: true, snapshot: true, pause: true, }],
  ['Page.mouseUp', { title: 'Mouse up', slowMo: true, snapshot: true, pause: true, }],
  ['Page.mouseClick', { title: 'Click', slowMo: true, snapshot: true, pause: true, }],
  ['Page.mouseWheel', { title: 'Mouse wheel', slowMo: true, snapshot: true, pause: true, }],
  ['Page.touchscreenTap', { title: 'Tap', slowMo: true, snapshot: true, pause: true, }],
