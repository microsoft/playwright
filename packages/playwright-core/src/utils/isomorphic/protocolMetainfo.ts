...
export const methodMetainfo = new Map<string, { internal?: boolean, title?: string, slowMo?: boolean, snapshot?: boolean, pausesBeforeInput?: boolean }>([
  ...
  ['BrowserContext.clockFastForward', { title: 'Fast forward clock "{ticks}"', }],
  ['BrowserContext.clockInstall', { title: 'Install clock "{time}"', }],
  ['BrowserContext.clockPauseAt', { title: 'Pause clock "{time}"', }],
  ['BrowserContext.clockResume', { title: 'Resume clock', }],
  ['BrowserContext.clockRunFor', { title: 'Run clock "{ticks}"', }],
  ['BrowserContext.clockSetFixedTime', { title: 'Set fixed time "{time}"', }],
  ['BrowserContext.clockSetSystemTime', { title: 'Set system time "{time}"', }],
