...
export const methodMetainfo = new Map<string, MethodMetainfo>([
  ...
  ['Page.overlayAdd', { title: 'Add overlay', group: 'configuration', }],
  ['Page.overlayRemove', { title: 'Remove overlay', group: 'configuration', }],
  ['Page.overlayHide', { title: 'Hide overlay', group: 'configuration', }],
  ['Page.overlayShow', { title: 'Show overlay', group: 'configuration', }],
  ['Page.overlayConfigure', { title: 'Configure overlay', group: 'configuration', }],
