...
export interface BrowserType<Unused = {}> {
  ...
  /**
   * Sets default context options that will be used for subsequent
   * [browser.newContext([options])](https://playwright.dev/docs/api/class-browser#browser-new-context),
   * [browser.newPage([options])](https://playwright.dev/docs/api/class-browser#browser-new-page) and
   ...
   * @param options
   */
  setDefaultContextOptions(options?: {
    /**
     * Whether to automatically download all the attachments. Defaults to `true` where all the downloads are accepted.
     */
    acceptDownloads?: boolean;
  ...
  /**
   * Sets default launch options that will be used for subsequent
   * [browserType.launch([options])](https://playwright.dev/docs/api/class-browsertype#browser-type-launch) and
   * [browserType.launchPersistentContext(userDataDir[, options])](https://playwright.dev/docs/api/class-browsertype#browser-type-launch-persistent-context).
   * @param options
   */
  setDefaultLaunchOptions(options?: {
    /**
     * Additional arguments to pass to the browser instance. The list of Chromium flags can be found
     * [here](http://peter.sh/experiments/chromium-command-line-switches/).
     */
