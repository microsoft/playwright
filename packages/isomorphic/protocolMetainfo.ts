...
export const methodMetainfo = new Map<string, MethodMetainfo>([
  ...
  ['BrowserContext.routeFromCache', { title: 'Route from cache', group: 'route', }],
  ['BrowserContext.unrouteFromCache', { title: 'Stop routing from cache', group: 'route', }],
  ...
  ['Page.routeFromCache', { title: 'Route from cache', group: 'route', }],
  ['Page.unrouteFromCache', { title: 'Stop routing from cache', group: 'route', }],
