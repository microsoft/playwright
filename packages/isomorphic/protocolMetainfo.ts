...
export const methodMetainfo = new Map<string, MethodMetainfo>([
  ...
  ['Frame.pressSequentially', { title: 'Press keys sequentially', slowMo: true, snapshot: true, pause: true, input: true, isAutoWaiting: true, }],
  ...
  ['Page.keyboardPressSequentially', { title: 'Press keys sequentially', slowMo: true, snapshot: true, pause: true, input: true, }],
