...
export type MethodMetainfo = { internal?: boolean, title?: string, subtitle?: string, renderParams?: string[], slowMo?: boolean, snapshot?: boolean, pause?: boolean, isAutoWaiting?: boolean, input?: boolean, group?: string };
...
export const methodMetainfo = new Map<string, MethodMetainfo>([
  ...
  ['BrowserContext.setOffline', { title: 'Set offline mode', renderParams: ['offline'], }],
  ...
  ['BrowserContext.showRecorder', { internal: true, }],
  ['BrowserContext.startRecording', { internal: true, }],
  ['BrowserContext.stopRecording', { internal: true, }],
  ...
  ['Frame.evalOnSelector', { title: 'Evaluate', subtitle: '{selector}', snapshot: true, pause: true, }],
  ['Frame.evalOnSelectorAll', { title: 'Evaluate', subtitle: '{selector}', snapshot: true, pause: true, }],
  ['Frame.addScriptTag', { title: 'Add script tag', renderParams: ['url'], snapshot: true, pause: true, }],
  ['Frame.addStyleTag', { title: 'Add style tag', renderParams: ['url'], snapshot: true, pause: true, }],
  ['Frame.ariaSnapshot', { title: 'Aria snapshot', subtitle: '{selector}', group: 'getter', }],
  ['Frame.ariaSnapshotJSON', { title: 'Aria snapshot JSON', subtitle: '{selector}', group: 'getter', }],
  ['Frame.blur', { title: 'Blur', subtitle: '{selector}', slowMo: true, snapshot: true, pause: true, }],
  ['Frame.check', { title: 'Check', subtitle: '{selector}', renderParams: ['position'], slowMo: true, snapshot: true, pause: true, input: true, isAutoWaiting: true, }],
  ['Frame.click', { title: 'Click', subtitle: '{selector}', renderParams: ['button', 'clickCount', 'modifiers', 'position'], slowMo: true, snapshot: true, pause: true, input: true, isAutoWaiting: true, }],
  ['Frame.content', { title: 'Get content', snapshot: true, pause: true, }],
  ['Frame.dragAndDrop', { title: 'Drag and drop', renderParams: ['source:selector', 'target:selector'], slowMo: true, snapshot: true, pause: true, input: true, isAutoWaiting: true, }],
  ['Frame.drop', { title: 'Drop files or data onto an element', subtitle: '{selector}', slowMo: true, snapshot: true, pause: true, input: true, isAutoWaiting: true, }],
  ['Frame.dblclick', { title: 'Double click', subtitle: '{selector}', renderParams: ['button', 'modifiers', 'position'], slowMo: true, snapshot: true, pause: true, input: true, isAutoWaiting: true, }],
  ['Frame.dispatchEvent', { title: 'Dispatch "{type}"', subtitle: '{selector}', renderParams: ['type'], slowMo: true, snapshot: true, pause: true, }],
  ...
  ['Frame.fill', { title: 'Fill "{value}"', subtitle: '{selector}', renderParams: ['value'], slowMo: true, snapshot: true, pause: true, input: true, isAutoWaiting: true, }],
  ['Frame.focus', { title: 'Focus', subtitle: '{selector}', slowMo: true, snapshot: true, pause: true, }],
  ...
  ['Frame.getAttribute', { title: 'Get attribute "{name}"', subtitle: '{selector}', snapshot: true, pause: true, group: 'getter', }],
  ['Frame.goto', { title: 'Navigate', subtitle: '{url}', renderParams: ['url'], slowMo: true, snapshot: true, pause: true, }],
  ['Frame.hover', { title: 'Hover', subtitle: '{selector}', renderParams: ['modifiers', 'position'], slowMo: true, snapshot: true, pause: true, input: true, isAutoWaiting: true, }],
  ['Frame.innerHTML', { title: 'Get HTML', subtitle: '{selector}', snapshot: true, pause: true, group: 'getter', }],
  ['Frame.innerText', { title: 'Get inner text', subtitle: '{selector}', snapshot: true, pause: true, group: 'getter', }],
  ['Frame.inputValue', { title: 'Get input value', subtitle: '{selector}', snapshot: true, pause: true, group: 'getter', }],
  ['Frame.isChecked', { title: 'Is checked', subtitle: '{selector}', snapshot: true, pause: true, group: 'getter', }],
  ['Frame.isDisabled', { title: 'Is disabled', subtitle: '{selector}', snapshot: true, pause: true, group: 'getter', }],
  ['Frame.isEnabled', { title: 'Is enabled', subtitle: '{selector}', snapshot: true, pause: true, group: 'getter', }],
  ['Frame.isHidden', { title: 'Is hidden', subtitle: '{selector}', snapshot: true, pause: true, group: 'getter', }],
  ['Frame.isVisible', { title: 'Is visible', subtitle: '{selector}', snapshot: true, pause: true, group: 'getter', }],
  ['Frame.isEditable', { title: 'Is editable', subtitle: '{selector}', snapshot: true, pause: true, group: 'getter', }],
  ['Frame.press', { title: 'Press "{key}"', subtitle: '{selector}', renderParams: ['key'], slowMo: true, snapshot: true, pause: true, input: true, isAutoWaiting: true, }],
  ['Frame.querySelector', { title: 'Query selector', subtitle: '{selector}', snapshot: true, }],
  ['Frame.querySelectorAll', { title: 'Query selector all', subtitle: '{selector}', snapshot: true, }],
  ['Frame.queryCount', { title: 'Query count', subtitle: '{selector}', snapshot: true, pause: true, }],
  ['Frame.selectOption', { title: 'Select option', subtitle: '{selector}', renderParams: ['options'], slowMo: true, snapshot: true, pause: true, input: true, isAutoWaiting: true, }],
  ['Frame.setContent', { title: 'Set content', snapshot: true, pause: true, }],
  ['Frame.setInputFiles', { title: 'Set input files', subtitle: '{selector}', renderParams: ['files=localPaths'], slowMo: true, snapshot: true, pause: true, input: true, isAutoWaiting: true, }],
  ['Frame.tap', { title: 'Tap', subtitle: '{selector}', renderParams: ['modifiers', 'position'], slowMo: true, snapshot: true, pause: true, input: true, isAutoWaiting: true, }],
  ['Frame.textContent', { title: 'Get text content', subtitle: '{selector}', snapshot: true, pause: true, group: 'getter', }],
  ['Frame.title', { title: 'Get page title', group: 'getter', }],
  ['Frame.type', { title: 'Type "{text}"', subtitle: '{selector}', renderParams: ['text'], slowMo: true, snapshot: true, pause: true, input: true, isAutoWaiting: true, }],
  ['Frame.uncheck', { title: 'Uncheck', subtitle: '{selector}', renderParams: ['position'], slowMo: true, snapshot: true, pause: true, input: true, isAutoWaiting: true, }],
  ['Frame.waitForTimeout', { title: 'Wait for timeout', renderParams: ['timeout=waitTimeout'], snapshot: true, }],
  ...
  ['ElementHandle.evalOnSelector', { title: 'Evaluate', subtitle: '{selector}', snapshot: true, pause: true, }],
  ['ElementHandle.evalOnSelectorAll', { title: 'Evaluate', subtitle: '{selector}', snapshot: true, pause: true, }],
  ['ElementHandle.boundingBox', { title: 'Get bounding box', snapshot: true, pause: true, }],
  ['ElementHandle.check', { title: 'Check', renderParams: ['position'], slowMo: true, snapshot: true, pause: true, input: true, isAutoWaiting: true, }],
  ['ElementHandle.click', { title: 'Click', renderParams: ['button', 'clickCount', 'modifiers', 'position'], slowMo: true, snapshot: true, pause: true, input: true, isAutoWaiting: true, }],
  ['ElementHandle.contentFrame', { title: 'Get content frame', group: 'getter', }],
  ['ElementHandle.dblclick', { title: 'Double click', renderParams: ['button', 'modifiers', 'position'], slowMo: true, snapshot: true, pause: true, input: true, isAutoWaiting: true, }],
  ['ElementHandle.dispatchEvent', { title: 'Dispatch event', renderParams: ['type'], slowMo: true, snapshot: true, pause: true, }],
  ['ElementHandle.fill', { title: 'Fill "{value}"', renderParams: ['value'], slowMo: true, snapshot: true, pause: true, input: true, isAutoWaiting: true, }],
  ...
  ['ElementHandle.hover', { title: 'Hover', renderParams: ['modifiers', 'position'], slowMo: true, snapshot: true, pause: true, input: true, isAutoWaiting: true, }],
  ...
  ['ElementHandle.press', { title: 'Press "{key}"', renderParams: ['key'], slowMo: true, snapshot: true, pause: true, input: true, isAutoWaiting: true, }],
  ['ElementHandle.querySelector', { title: 'Query selector', subtitle: '{selector}', snapshot: true, }],
  ['ElementHandle.querySelectorAll', { title: 'Query selector all', subtitle: '{selector}', snapshot: true, }],
  ['ElementHandle.screenshot', { title: 'Screenshot', renderParams: ['type'], snapshot: true, pause: true, }],
  ['ElementHandle.scrollIntoViewIfNeeded', { title: 'Scroll into view', slowMo: true, snapshot: true, pause: true, }],
  ['ElementHandle.selectOption', { title: 'Select option', renderParams: ['options'], slowMo: true, snapshot: true, pause: true, input: true, isAutoWaiting: true, }],
  ['ElementHandle.selectText', { title: 'Select text', slowMo: true, snapshot: true, pause: true, }],
  ['ElementHandle.setInputFiles', { title: 'Set input files', renderParams: ['files=localPaths'], slowMo: true, snapshot: true, pause: true, input: true, isAutoWaiting: true, }],
  ['ElementHandle.tap', { title: 'Tap', renderParams: ['modifiers', 'position'], slowMo: true, snapshot: true, pause: true, input: true, isAutoWaiting: true, }],
  ['ElementHandle.textContent', { title: 'Get text content', snapshot: true, pause: true, group: 'getter', }],
  ['ElementHandle.type', { title: 'Type', renderParams: ['text'], slowMo: true, snapshot: true, pause: true, input: true, isAutoWaiting: true, }],
  ['ElementHandle.uncheck', { title: 'Uncheck', renderParams: ['position'], slowMo: true, snapshot: true, pause: true, input: true, isAutoWaiting: true, }],
  ['ElementHandle.waitForElementState', { title: 'Wait for state', renderParams: ['state'], snapshot: true, pause: true, }],
  ['ElementHandle.waitForSelector', { title: 'Wait for selector', subtitle: '{selector}', renderParams: ['state'], snapshot: true, }],
  ...
  ['Page.emulateMedia', { title: 'Emulate media', renderParams: ['media', 'colorScheme', 'reducedMotion', 'forcedColors', 'contrast'], snapshot: true, pause: true, }],
  ...
  ['Page.registerLocatorHandler', { title: 'Register locator handler', subtitle: '{selector}', }],
  ...
  ['Page.expectScreenshot', { title: 'Expect screenshot', subtitle: '{locator.selector}', snapshot: true, pause: true, }],
  ['Page.screenshot', { title: 'Screenshot', renderParams: ['type', 'fullPage'], snapshot: true, pause: true, }],
  ...
  ['Page.setViewportSize', { title: 'Set viewport size', renderParams: ['viewportSize.width', 'viewportSize.height'], snapshot: true, pause: true, }],
  ['Page.keyboardDown', { title: 'Key down "{key}"', renderParams: ['key'], slowMo: true, snapshot: true, pause: true, input: true, }],
  ['Page.keyboardUp', { title: 'Key up "{key}"', renderParams: ['key'], slowMo: true, snapshot: true, pause: true, input: true, }],
  ['Page.keyboardInsertText', { title: 'Insert "{text}"', renderParams: ['text'], slowMo: true, snapshot: true, pause: true, input: true, }],
  ['Page.keyboardType', { title: 'Type "{text}"', renderParams: ['text'], slowMo: true, snapshot: true, pause: true, input: true, }],
  ['Page.keyboardPress', { title: 'Press "{key}"', renderParams: ['key'], slowMo: true, snapshot: true, pause: true, input: true, }],
  ['Page.mouseMove', { title: 'Mouse move', renderParams: ['x', 'y'], slowMo: true, snapshot: true, pause: true, input: true, }],
  ['Page.mouseDown', { title: 'Mouse down', renderParams: ['button', 'clickCount'], slowMo: true, snapshot: true, pause: true, input: true, }],
  ['Page.mouseUp', { title: 'Mouse up', renderParams: ['button', 'clickCount'], slowMo: true, snapshot: true, pause: true, input: true, }],
  ['Page.mouseClick', { title: 'Click', renderParams: ['x', 'y', 'button', 'clickCount'], slowMo: true, snapshot: true, pause: true, input: true, }],
  ['Page.mouseWheel', { title: 'Mouse wheel', renderParams: ['deltaX', 'deltaY'], slowMo: true, snapshot: true, pause: true, input: true, }],
  ['Page.touchscreenTap', { title: 'Tap', renderParams: ['x', 'y'], slowMo: true, snapshot: true, pause: true, input: true, }],
  ...
  ['Dialog.accept', { title: 'Accept dialog', renderParams: ['promptText'], }],
