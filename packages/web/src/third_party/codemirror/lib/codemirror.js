...
(function (global, factory) {
  ...
  */
  ...
  function rootNode(cm) { return cm.display.wrapper.getRootNode() }
  ...
  function endOperation_W2(op) {
    ...
    var takeFocus = op.focus && op.focus == activeElt(rootNode(cm));
  ...
  function selectionSnapshot(cm) {
    ...
    var active = activeElt(rootNode(cm));
  ...
  ContentEditableInput.prototype.init = function (display) {
    ...
    function onCopyCut(e) {
      ...
      var hadFocus = activeElt(div.getRootNode());
      selectInput(te);
      setTimeout(function () {
  ...
  function fromTextArea(textarea, options) {
    ...
    if (options.autofocus == null) {
      var hasFocus = activeElt(textarea.getRootNode());
