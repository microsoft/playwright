...
export const TestFilesHeader: React.FC<{
  ...
  const metadataToggleButton = !isMetadataEmpty(report.metadata) && (
    <button className={clsx('metadata-toggle', !isMetadataInTopLine && 'metadata-toggle-second-line')} onClick={toggleMetadataVisible} title={metadataVisible ? 'Hide metadata' : 'Show metadata'}>
