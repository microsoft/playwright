...
export class BrowserType extends ChannelOwner<channels.BrowserTypeChannel, channels.BrowserTypeInitializer> implements api.BrowserType {
  ...
  connect(options: api.ConnectOptions): Promise<api.Browser>;
  connect(wsEndpoint: string, options?: api.ConnectOptions): Promise<api.Browser>;
  async connect(optionsOrWsEndpoint: string|api.ConnectOptions, options?: api.ConnectOptions): Promise<Browser>{
  ...
  connectOverCDP(options: api.ConnectOverCDPOptions): Promise<api.Browser>;
  connectOverCDP(endpointURL: string, options?: api.ConnectOverCDPOptions): Promise<api.Browser>;
  connectOverCDP(endpointURLOrOptions: api.ConnectOverCDPOptions|string, options?: api.ConnectOverCDPOptions) {
