...
export function runDriver() {
  ...
  assert(process.env.PW_CLI_TARGET_LANG, `'PW_CLI_TARGET_LANG' env var needs to be specified when launching the driver`);
  const playwright = createPlaywright({ cliLanguage: process.env.PW_CLI_TARGET_LANG });
