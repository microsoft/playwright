...
import type { Fixtures, FullConfig, PlaywrightTestArgs, PlaywrightTestOptions, PlaywrightWorkerArgs, PlaywrightWorkerOptions, TestInfo } from '../../../types/test';
import { BrowserContextOptions, Page } from '../../../types/types';
import { artifactsFolder } from './browserFixtures';

export const pageFixtures: Fixtures<PlaywrightTestArgs & PlaywrightTestOptions, {}, {}, PlaywrightWorkerArgs & PlaywrightWorkerOptions> = {
  screenshot: 'off',
  video: 'off',
  trace: 'off',
