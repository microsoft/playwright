...
DEPS['src/remote/'] = ['src/client/', 'src/debug/', 'src/dispatchers/', 'src/server/', 'src/server/supplements/', 'src/server/electron/', 'src/server/trace/', 'src/utils/processLauncher.ts'];
...
DEPS['src/test/'] = ['src/test/**', 'src/utils/utils.ts', 'src/utils/processLauncher.ts'];
