...
import type { CallMetadata } from '../callMetadata';` + (target === 'Dispatcher' ? `
...
writeFile(path.join(__dirname, '..', 'packages', 'protocol', 'src', 'client', 'channels.d.ts'), client_channels_ts.join('\n') + '\n');
writeFile(path.join(__dirname, '..', 'packages', 'protocol', 'src', 'server', 'channels.d.ts'), server_channels_ts.join('\n') + '\n');
