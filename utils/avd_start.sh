...
# nohup ${ANDROID_HOME}/emulator/emulator -avd android34 -gpu swiftshader &
nohup ${ANDROID_HOME}/emulator/emulator -avd android34 -no-audio -no-window -no-boot-anim -no-snapshot &
