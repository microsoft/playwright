...
const noWebGlobalsRuleList = [
  ...
  { name: "setTimeout", message: "Use builtins().setTimeout instead" },
  { name: "clearTimeout", message: "Use builtins().clearTimeout instead" },
  { name: "setInterval", message: "Use builtins().setInterval instead" },
  { name: "clearInterval", message: "Use builtins().clearInterval instead" },
  { name: "requestAnimationFrame", message: "Use builtins().requestAnimationFrame instead" },
  { name: "cancelAnimationFrame", message: "Use builtins().cancelAnimationFrame instead" },
  { name: "requestIdleCallback", message: "Use builtins().requestIdleCallback instead" },
  { name: "cancelIdleCallback", message: "Use builtins().cancelIdleCallback instead" },
  { name: "performance", message: "Use builtins().performance instead" },
  { name: "eval", message: "Use builtins().eval instead" },
  { name: "Date", message: "Use builtins().Date instead" },
  { name: "Map", message: "Use builtins().Map instead" },
  { name: "Set", message: "Use builtins().Set instead" },
];
