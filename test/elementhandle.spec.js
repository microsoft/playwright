...
const {FIREFOX, CHROMIUM, WEBKIT, pageEnv, launchEnv} = require('playwright-runner');
const {it} = require('./environments/server');

describe('ElementHandle.boundingBox', function() {
  it.todo(FIREFOX && !HEADLESS)('should work', async ({page, server}) => {
  ...
  it.skip(FIREFOX)('should work with page scale', async ({browser, server}) => {
