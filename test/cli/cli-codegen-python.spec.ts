...
const launchOptions = process.env.PW_CHROMIUM_CHANNEL ? `headless=False, channel="${process.env.PW_CHROMIUM_CHANNEL}"` : 'headless=False';
...
def run(playwright):
    browser = playwright.${browserName}.launch(${launchOptions})
