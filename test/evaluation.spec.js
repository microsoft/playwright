 ...
 */
const {FIREFOX, CHROMIUM, WEBKIT, USES_HOOKS} = require('playwright-runner');
...
describe('Page.evaluate', function() {
  ...
  it.todo(WEBKIT)('should not throw an error when evaluation does a synchronous navigation and returns an object', async ({page, server}) => {
  ...
  it.todo(FIREFOX)('should await promise from popup', async function({page, server}) {
