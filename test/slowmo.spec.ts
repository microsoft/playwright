...
it.skip(options.WIRE)('Page SlowMo $$eval', async ({page, toImpl}) => {
  await checkPageSlowMo(toImpl, page, () => page.$$eval('button', () => void 0));
});
it.skip(options.WIRE)('Page SlowMo $eval', async ({page, toImpl}) => {
  await checkPageSlowMo(toImpl, page, () => page.$eval('button', () => void 0));
});
it.skip(options.WIRE)('Page SlowMo check', async ({page, toImpl}) => {
  await checkPageSlowMo(toImpl, page, () => page.check('.check'));
});
it.skip(options.WIRE)('Page SlowMo click', async ({page, toImpl}) => {
  await checkPageSlowMo(toImpl, page, () => page.click('button'));
});
it.skip(options.WIRE)('Page SlowMo dblclick', async ({page, toImpl}) => {
  await checkPageSlowMo(toImpl, page, () => page.dblclick('button'));
});
it.skip(options.WIRE)('Page SlowMo dispatchEvent', async ({page, toImpl}) => {
  await checkPageSlowMo(toImpl, page, () => page.dispatchEvent('button', 'click'));
});
it.skip(options.WIRE)('Page SlowMo emulateMedia', async ({page, toImpl}) => {
  await checkPageSlowMo(toImpl, page, () => page.emulateMedia({media: 'print'}));
});
it.skip(options.WIRE)('Page SlowMo evaluate', async ({page, toImpl}) => {
  await checkPageSlowMo(toImpl, page, () => page.evaluate(() => void 0));
});
it.skip(options.WIRE)('Page SlowMo evaluateHandle', async ({page, toImpl}) => {
  await checkPageSlowMo(toImpl, page, () => page.evaluateHandle(() => window));
});
it.skip(options.WIRE)('Page SlowMo fill', async ({page, toImpl}) => {
  await checkPageSlowMo(toImpl, page, () => page.fill('.fill', 'foo'));
});
it.skip(options.WIRE)('Page SlowMo focus', async ({page, toImpl}) => {
  await checkPageSlowMo(toImpl, page, () => page.focus('button'));
});
it.skip(options.WIRE)('Page SlowMo goto', async ({page, toImpl}) => {
  await checkPageSlowMo(toImpl, page, () => page.goto('about:blank'));
});
it.skip(options.WIRE)('Page SlowMo hover', async ({page, toImpl}) => {
  await checkPageSlowMo(toImpl, page, () => page.hover('button'));
});
it.skip(options.WIRE)('Page SlowMo press', async ({page, toImpl}) => {
  await checkPageSlowMo(toImpl, page, () => page.press('button', 'Enter'));
});
it.skip(options.WIRE)('Page SlowMo reload', async ({page, toImpl}) => {
  await checkPageSlowMo(toImpl, page, () => page.reload());
});
it.skip(options.WIRE)('Page SlowMo setContent', async ({page, toImpl}) => {
  await checkPageSlowMo(toImpl, page, () => page.setContent('hello world'));
});
it.skip(options.WIRE)('Page SlowMo selectOption', async ({page, toImpl}) => {
  await checkPageSlowMo(toImpl, page, () => page.selectOption('select', 'foo'));
});
it.skip(options.WIRE)('Page SlowMo setInputFiles', async ({page, toImpl}) => {
  await checkPageSlowMo(toImpl, page, () => page.setInputFiles('.file', []));
});
it.skip(options.WIRE)('Page SlowMo setViewportSize', async ({page, toImpl}) => {
  await checkPageSlowMo(toImpl, page, () => page.setViewportSize({height: 400, width: 400}));
});
it.skip(options.WIRE)('Page SlowMo type', async ({page, toImpl}) => {
  await checkPageSlowMo(toImpl, page, () => page.type('.fill', 'a'));
});
it.skip(options.WIRE)('Page SlowMo uncheck', async ({page, toImpl}) => {
