...
module.exports.addTests = function({testRunner, expect, playwright, FFOX, CHROME, WEBKIT}) {
  ...
  describe('Page.click', function() {
    ...
    it.skip(WEBKIT)('should click the button with relative point', async({page, server}) => {
      await page.goto(server.PREFIX + '/input/button.html');
    ...
    it.skip(WEBKIT)('should click the button with px border with relative point', async({page, server}) => {
      await page.goto(server.PREFIX + '/input/button.html');
    ...
    it.skip(WEBKIT)('should click the button with em border with relative point', async({page, server}) => {
      await page.goto(server.PREFIX + '/input/button.html');
    ...
    it.skip(WEBKIT)('should click a very large button with relative point', async({page, server}) => {
      await page.goto(server.PREFIX + '/input/button.html');
