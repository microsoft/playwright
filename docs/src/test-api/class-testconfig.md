...
- type: ?<[Object]|[Array]<[Object]>>
  ...
  - `stderr` ?<["pipe"|"ignore"]> If `"pipe"`, it will pipe the stderr of the command to the process stderr. If `"ignore"`, it will ignore the stderr of the command. Default to `"pipe"`.
