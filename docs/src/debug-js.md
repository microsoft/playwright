...
Since Playwright runs in Node.js, you can debug it with your debugger of choice e.g. inside your IDE. Playwright comes with the Playwright Inspector which allows you to step through Playwright API calls, see their debug logs and explore [selectors](./selectors.md). For a better developer experience we recommend the [VS Code extension](./getting-started-vscode.md) which allows you to debug directly inside [Visual Studio Code](./getting-started-vscode.md#debugging-tests).
