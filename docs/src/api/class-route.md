...
[CORS](https://developer.mozilla.org/en-US/docs/Web/HTTP/CORS) headers won't be added. Note that all CORS
headers configured via `headers` option will take precedence.
