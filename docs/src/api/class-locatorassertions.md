...
Ensures the [Locator] points to an element that contains the given CSS classes.
...
await expect(itemLocator).toContainClass(['alice', 'bob', 'carl']); // no carl class found
```
