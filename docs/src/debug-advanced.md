...
**For Chromium**: You can also open developer tools through a launch option inside your [Playwright Test config](./test-configuration.md#more-browser-and-context-options) under `use > launchOptions` and set `devtools: true`.
