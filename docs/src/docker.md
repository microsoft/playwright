...
```bash js
docker pull mcr.microsoft.com/playwright:v1.22.1-focal
```

```bash python
docker pull mcr.microsoft.com/playwright/python:v1.22.1-focal
```

```bash csharp
docker pull mcr.microsoft.com/playwright/dotnet:v1.22.1-focal
```

```bash java
docker pull mcr.microsoft.com/playwright/java:v1.22.1-focal
```
...
```bash js
docker run -it --rm --ipc=host mcr.microsoft.com/playwright:v1.22.1-focal /bin/bash
```

```bash python
docker run -it --rm --ipc=host mcr.microsoft.com/playwright/python:v1.22.1-focal /bin/bash
```

```bash csharp
docker run -it --rm --ipc=host mcr.microsoft.com/playwright/dotnet:v1.22.1-focal /bin/bash
```

```bash java
docker run -it --rm --ipc=host mcr.microsoft.com/playwright/java:v1.22.1-focal /bin/bash
```
...
```bash js
docker run -it --rm --ipc=host --user pwuser --security-opt seccomp=seccomp_profile.json mcr.microsoft.com/playwright:v1.22.1-focal /bin/bash
```

```bash python
docker run -it --rm --ipc=host --user pwuser --security-opt seccomp=seccomp_profile.json mcr.microsoft.com/playwright/python:v1.22.1-focal /bin/bash
```

```bash csharp
docker run -it --rm --ipc=host --user pwuser --security-opt seccomp=seccomp_profile.json mcr.microsoft.com/playwright/dotnet:v1.22.1-focal /bin/bash
```

```bash java
docker run -it --rm --ipc=host --user pwuser --security-opt seccomp=seccomp_profile.json mcr.microsoft.com/playwright/java:v1.22.1-focal /bin/bash
```
