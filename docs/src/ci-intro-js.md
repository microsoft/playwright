...
- [How to use GitHub Actions to run your tests](/intro.md#github-actions)
- [How to create a repo and push to GitHub](/intro.md#create-a-repo-and-push-to-github)
- [How to open the workflows](/intro.md#opening-the-workflows)
- [How to view the test logs](/intro.md#viewing-test-logs)
- [How to download the report from GitHub](/intro.md#downloading-the-playwright-report)
- [How to view the report](/intro.md#viewing-the-playwright-report)
- [How to view the trace](/intro.md#viewing-the-trace)
