...
* Browsercontext - multi-page scenarios and cleaner way to manage multiple independent browser windows
* Click waits for elements and visible by default
* Support for Firefox and WebKit, breadth of API support
...
Playwright is being actively developed as we get to feature parity across Chromium, Firefox and WebKit. Progress on each browser can be tracked on the [Is Playwright Ready?](https://aslushnikov.github.io/isplaywrightready/) page, which shows the test suite status for every browser.

## Resources

* [API documentation](https://github.com/microsoft/playwright/blob/master/docs/api.md)
* [Selector engines](https://github.com/microsoft/playwright/blob/master/docs/selectors.md)
