...
> **Fork:** This repo is [**playwright-api-trace-viewer**](FORK.md) — a fork of [microsoft/playwright](https://github.com/microsoft/playwright) with API-focused trace viewer enhancements. It is not the official Playwright project.
