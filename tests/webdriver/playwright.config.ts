...
process.env.PWPAGE_IMPL = 'webkit-webdriver';
...
config.projects!.push({
  name: 'webkit-webdriver-page',
  use: {
    browserName: 'webkit',
  },
  snapshotPathTemplate: '{testDir}/{testFileDir}/{testFileName}-snapshots/{arg}-webkit-webdriver{ext}',
