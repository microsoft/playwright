...
test.describe('update', () => {
  test('update props without remounting', async ({ mount }) => {
     ...
     * However it seems impossible to update the props, children or events of a rendered component
     */
  ...
  test('update children without remounting', async ({ mount }) => {
    const component = await mount(<Counter>Default Children</Counter>);
    await expect(component.getByTestId('children')).toContainText('Default Children');
  
    await component.update(<Counter>Test Children</Counter>);
    await expect(component.getByTestId('children')).not.toContainText('Default Children');
    await expect(component.getByTestId('children')).toContainText('Test Children');
