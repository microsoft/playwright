...
test('should report matcherResults for web matchers', async ({ runInlineTest }) => {
  ...
  expect(errors).toEqual([
    ...
    { expected: 'empty', actual: 'notEmpty' },
    { expected: 'enabled', actual: 'enabled' },
    { expected: 'focused', actual: 'inactive' },
    { expected: 'hidden', actual: 'visible' },
    { expected: 'in viewport', actual: 'in viewport' },
    { expected: 'visible', actual: 'visible' },
    { expected: 'World', actual: 'Hello' },
    { expected: 'World', actual: '' },
    { expected: 'World', actual: '' },
    { expected: 'value', actual: null },
    { expected: 'have attribute', actual: 'not have attribute' },
    { expected: 'name', actual: '' },
    { expected: 2, actual: 1 },
    { expected: '10', actual: 'auto' },
    { expected: 'id', actual: '' },
    { expected: 'value' },
