...
test.describe('cli codegen', () => {
  ...
  test.skip('should contain second page', async ({ openRecorder, page }) => {
    const recorder = await openRecorder();
  ...
  test.skip('should download files', async ({ page, openRecorder, server }) => {
    const recorder = await openRecorder();
  ...
  test.skip('should record open in a new tab with url', async ({ page, openRecorder, browserName, platform }) => {
    const recorder = await openRecorder();
  ...
  test.skip('should not clash pages', async ({ page, openRecorder, browserName }) => {
    const recorder = await openRecorder();
