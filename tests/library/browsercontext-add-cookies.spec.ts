...
it('should set cookies with SameSite attribute and no secure attribute', async ({ context, browserName, isWindows, isMac, defaultSameSiteCookieValue }) => {
  ...
  }, ...(browserName === 'chromium' || (browserName === 'webkit' && !isMac) ? [] : [{
    name: 'same-site-none',
    value: '1',
    domain: 'foo.com',
    path: '/',
