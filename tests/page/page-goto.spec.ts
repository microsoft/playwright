...
it('should fail when server returns 204', async ({ page, server, browserName, isMac }) => {
  it.fixme(browserName === 'webkit' && isMac, 'Regressed in https://github.com/microsoft/playwright-browsers/pull/1297');
