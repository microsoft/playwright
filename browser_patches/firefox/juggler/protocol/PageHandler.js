...
export class PageHandler {
  ...
  async ['Page.setViewportSize']({viewportSize, screenSize}) {
    await this._pageTarget.setViewportSize(viewportSize === null ? undefined : viewportSize, screenSize === null ? undefined : screenSize);
  }
