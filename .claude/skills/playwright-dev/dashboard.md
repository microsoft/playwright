...
Read the skill at packages/playwright-core/src/tools/cli-client/skill/SKILL.md for full playwright cli skill. Remember that in this environment, "npx playwright cli" is used instead of playwright-cli.
